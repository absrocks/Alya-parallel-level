...
{
  my_int i, j, k, nvtxs, maxlnz, maxsub;
  idxtype *xadj, *adjncy;
...
*
*******************************************************************/
my_int smbfct(my_int neqns, idxtype *xadj, idxtype *adjncy, idxtype *perm, idxtype *invp, idxtype *xlnz, 
           my_int *maxlnz, idxtype *xnzsub, idxtype *nzsub, my_int *maxsub)
{
  /* Local variables */
  my_int node, rchm, mrgk, lmax, i, j, k, m, nabor, nzbeg, nzend;
  my_int kxsub, jstop, jstrt, mrkflg, inz, knz, flag;

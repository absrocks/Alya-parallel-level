...
**************************************************************************/
void CompressGraph(CtrlType *ctrl, GraphType *graph, my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *cptr, idxtype *cind)
{
  my_int i, ii, iii, j, jj, k, l, cnvtxs, cnedges;
...
* than factor*average
**************************************************************************/
void PruneGraph(CtrlType *ctrl, GraphType *graph, my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *iperm, float factor)
{
  my_int i, j, k, l, nlarge, pnvtxs, pnedges;

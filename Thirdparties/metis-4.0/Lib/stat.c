...
**************************************************************************/
void ComputePartitionInfo(GraphType *graph, my_int nparts, idxtype *where)
{
  my_int i, j, k, nvtxs, ncon, mustfree=0;
...
* This function computes cuts and balance information
**************************************************************************/
void ComputePartitionInfoBipartite(GraphType *graph, my_int nparts, idxtype *where)
{
  my_int i, j, k, nvtxs, ncon, mustfree=0;
...
**************************************************************************/
void ComputePartitionBalance(GraphType *graph, my_int nparts, idxtype *where, float *ubvec)
{
...
**************************************************************************/
float ComputeElementBalance(my_int ne, my_int nparts, idxtype *where)
{
  my_int i;
  idxtype *kpwgts;
  float balance;

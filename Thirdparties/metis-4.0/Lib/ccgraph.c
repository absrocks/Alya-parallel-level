...
**************************************************************************/
void CreateCoarseGraph(CtrlType *ctrl, GraphType *graph, my_int cnvtxs, idxtype *match, idxtype *perm)
{
  my_int i, j, jj, k, kk, l, m, istart, iend, nvtxs, nedges, ncon, cnedges, v, u, mask, dovsize;
...
* This function creates the coarser graph
**************************************************************************/
void CreateCoarseGraphNoMask(CtrlType *ctrl, GraphType *graph, my_int cnvtxs, idxtype *match, idxtype *perm)
{
  my_int i, j, k, m, istart, iend, nvtxs, nedges, ncon, cnedges, v, u, dovsize;
  idxtype *xadj, *vwgt, *vsize, *adjncy, *adjwgt, *adjwgtsum, *auxadj;
  idxtype *cmap, *htable;
  idxtype *cxadj, *cvwgt, *cvsize, *cadjncy, *cadjwgt, *cadjwgtsum;
  float *nvwgt, *cnvwgt;
...
* This function creates the coarser graph
**************************************************************************/
void CreateCoarseGraph_NVW(CtrlType *ctrl, GraphType *graph, my_int cnvtxs, idxtype *match, idxtype *perm)
{
  my_int i, j, jj, k, kk, l, m, istart, iend, nvtxs, nedges, ncon, cnedges, v, u, mask;
...
**************************************************************************/
GraphType *SetUpCoarseGraph(GraphType *graph, my_int cnvtxs, my_int dovsize)
{
  GraphType *cgraph;
...
**************************************************************************/
void ReAdjustMemory(GraphType *graph, GraphType *cgraph, my_int dovsize) 
{

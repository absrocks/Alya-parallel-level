...
**************************************************************************/
void Random_KWayEdgeRefineMConn(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor, my_int npasses, my_int ffactor)
{
  my_int i, ii, iii, j, jj, k, l, pass, nvtxs, nmoves, nbnd, tvwgt, myndegrees; 
  my_int from, me, to, oldcut, vwgt, gain;
  my_int maxndoms, nadd;
...
* This function performs k-way refinement
**************************************************************************/
void Greedy_KWayEdgeBalanceMConn(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor, my_int npasses)
{
  my_int i, ii, iii, j, jj, k, l, pass, nvtxs, nbnd, tvwgt, myndegrees, oldgain, gain, nmoves; 
  my_int from, me, to, oldcut, vwgt, maxndoms, nadd;
  idxtype *xadj, *adjncy, *adjwgt;
...
**************************************************************************/
void PrintSubDomainGraph(GraphType *graph, my_int nparts, idxtype *where)
{
  my_int i, j, k, me, nvtxs, total, max;
...
* This function computes the subdomain graph
**************************************************************************/
void ComputeSubDomainGraph(GraphType *graph, my_int nparts, idxtype *pmat, idxtype *ndoms)
{
...
* This function computes the subdomain graph
**************************************************************************/
void EliminateSubDomainEdges(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts)
{
...
void MoveGroupMConn(CtrlType *ctrl, GraphType *graph, idxtype *ndoms, idxtype *pmat,
                    my_int nparts, my_int to, my_int nind, idxtype *ind)
{
  my_int i, ii, iii, j, jj, k, l, nvtxs, nbnd, myndegrees; 
  my_int from, me;
  idxtype *xadj, *adjncy, *adjwgt;
...
* remove some of them
**************************************************************************/
void EliminateComponents(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor)
{
  my_int i, ii, j, jj, k, me, nvtxs, tvwgt, first, last, nleft, ncmps, cwgt, other, target, deltawgt;
...
* This function moves a collection of vertices and updates their rinfo
**************************************************************************/
void MoveGroup(CtrlType *ctrl, GraphType *graph, my_int nparts, my_int to, my_int gid, idxtype *ptr, idxtype *ind)
{
  my_int i, ii, iii, j, jj, k, l, nvtxs, nbnd, myndegrees; 
  my_int from, me;
  idxtype *xadj, *adjncy, *adjwgt;

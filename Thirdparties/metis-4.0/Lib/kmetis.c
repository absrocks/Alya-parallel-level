...
**************************************************************************/
void METIS_PartGraphKway(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
...
**************************************************************************/
void METIS_WPartGraphKway(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                          idxtype *adjwgt, my_int *wgtflag, my_int *numflag, my_int *nparts, 
...
**************************************************************************/
my_int MlevelKWayPartitioning(CtrlType *ctrl, GraphType *graph, my_int nparts, idxtype *part, float *tpwgts, float ubfactor)
{
  my_int i, j, nvtxs, tvwgt, tpwgts2[2];
  GraphType *cgraph;
  my_int wgtflag=3, numflag=0, options[10], edgecut;

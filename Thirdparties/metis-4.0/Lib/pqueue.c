...
**************************************************************************/
void PQueueInit(CtrlType *ctrl, PQueueType *queue, my_int maxnodes, my_int maxgain)
{
  my_int i, j, ncore;
...
**************************************************************************/
my_int PQueueGetSize(PQueueType *queue)
{
  return queue->nnodes;
}
...
**************************************************************************/
my_int PQueueInsert(PQueueType *queue, my_int node, my_int gain)
{
  my_int i, j, k;
  idxtype *locator;
...
* an updated gain
**************************************************************************/
my_int PQueueDelete(PQueueType *queue, my_int node, my_int gain)
{
  my_int i, j, newgain, oldgain;
  idxtype *locator;
...
* an updated gain
**************************************************************************/
my_int PQueueUpdate(PQueueType *queue, my_int node, my_int oldgain, my_int newgain)
{
  my_int i, j;
  idxtype *locator;
  ListNodeType *newnode;
...
* an updated gain
**************************************************************************/
void PQueueUpdateUp(PQueueType *queue, my_int node, my_int oldgain, my_int newgain)
{
  my_int i, j;
  idxtype *locator;
  ListNodeType *newnode, **buckets;
...
**************************************************************************/
my_int PQueueGetMax(PQueueType *queue)
{
  my_int vtx, i, j, gain, node;
  idxtype *locator;
  ListNodeType *tptr;
  KeyValueType *heap;
...
* This function returns the vertex with the largest gain from a partition
**************************************************************************/
my_int PQueueSeeMax(PQueueType *queue)
{
  my_int vtx;
...
* This function returns the vertex with the largest gain from a partition
**************************************************************************/
my_int PQueueGetKey(PQueueType *queue)
{
  my_int key;
...
**************************************************************************/
my_int CheckHeap(PQueueType *queue)
{
  my_int i, j, nnodes;
  idxtype *locator;
  KeyValueType *heap;

...
**************************************************************************/
my_int AreAllVwgtsBelow(my_int ncon, float alpha, float *vwgt1, float beta, float *vwgt2, float limit)
{
  my_int i;
...
* a given set of values
**************************************************************************/
my_int AreAnyVwgtsBelow(my_int ncon, float alpha, float *vwgt1, float beta, float *vwgt2, float limit)
{
  my_int i;
...
* a given set of values
**************************************************************************/
my_int AreAllVwgtsAbove(my_int ncon, float alpha, float *vwgt1, float beta, float *vwgt2, float limit)
{
  my_int i;
...
**************************************************************************/ 
float ComputeLoadImbalance(my_int ncon, my_int nparts, float *npwgts, float *tpwgts)
{
  my_int i, j;
  float max, lb=0.0;
...
* a given set of values
**************************************************************************/
my_int AreAllBelow(my_int ncon, float *v1, float *v2)
{
  my_int i;

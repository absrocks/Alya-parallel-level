...
* in options[7] 
**************************************************************************/
void METIS_PartGraphKway2(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                         idxtype *adjwgt, my_int *wgtflag, my_int *numflag, my_int *nparts, 
...
* in options[7] 
**************************************************************************/
void METIS_WPartGraphKway2(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                          idxtype *adjwgt, my_int *wgtflag, my_int *numflag, my_int *nparts, 
                          float *tpwgts, my_int *options, my_int *edgecut, idxtype *part)
{
  my_int i, j;
  GraphType graph;
  CtrlType ctrl;
...
**************************************************************************/
void METIS_NodeNDP(my_int nvtxs, idxtype *xadj, idxtype *adjncy, my_int npes, 
                   my_int *options, idxtype *perm, idxtype *iperm, idxtype *sizes) 
{
...
**************************************************************************/
void MlevelNestedDissectionP(CtrlType *ctrl, GraphType *graph, idxtype *order, my_int lastvtx, 
                             my_int npes, my_int cpos, idxtype *sizes)
{
...
**************************************************************************/
void METIS_NodeComputeSeparator(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
           idxtype *adjwgt, my_int *options, my_int *sepsize, idxtype *part) 
{
  my_int i, j, tvwgt, tpwgts[2];
  GraphType graph;
  CtrlType ctrl;
...
* vertices. It is for the case that the matrix has been pre-compressed.
**************************************************************************/
void METIS_EdgeComputeSeparator(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
           idxtype *adjwgt, my_int *options, my_int *sepsize, idxtype *part) 
{
  my_int i, j, tvwgt, tpwgts[2];
  GraphType graph;

...
**************************************************************************/
void MocFM_2WayEdgeRefine(CtrlType *ctrl, GraphType *graph, float *tpwgts, my_int npasses)
{
  my_int i, ii, j, k, l, kwgt, nvtxs, ncon, nbnd, nswaps, from, to, pass, me, limit, tmp, cnum;
  ...
  my_int higain, oldgain, mincut, initcut, newcut, mincutorder;
  float rtpwgts[2];
...
**************************************************************************/ 
void SelectQueue(my_int ncon, float *npwgts, float *tpwgts, my_int *from, my_int *cnum, PQueueType queues[MAXNCON][2])
{
  my_int i, part, maxgain=0;
...
**************************************************************************/ 
my_int BetterBalance(my_int ncon, float *npwgts, float *tpwgts, float *diff)
{
  my_int i;
  float ndiff[MAXNCON];
...
**************************************************************************/ 
float Compute2WayHLoadImbalance(my_int ncon, float *npwgts, float *tpwgts)
{
  my_int i;
  float max=0.0, temp;
...
**************************************************************************/ 
void Compute2WayHLoadImbalanceVec(my_int ncon, float *npwgts, float *tpwgts, float *lbvec)
{
  my_int i;

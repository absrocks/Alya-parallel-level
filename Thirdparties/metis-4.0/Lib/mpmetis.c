...
**************************************************************************/
void METIS_mCPartGraphRecursive(my_int *nvtxs, my_int *ncon, idxtype *xadj, idxtype *adjncy, 
       idxtype *vwgt, idxtype *adjwgt, my_int *wgtflag, my_int *numflag, my_int *nparts, 
       my_int *options, my_int *edgecut, idxtype *part)
{
  my_int i, j;
  GraphType graph;
  CtrlType ctrl;
...
* for the target partitions
**************************************************************************/
void METIS_mCHPartGraphRecursive(my_int *nvtxs, my_int *ncon, idxtype *xadj, idxtype *adjncy, 
       idxtype *vwgt, idxtype *adjwgt, my_int *wgtflag, my_int *numflag, my_int *nparts, 
       float *ubvec, my_int *options, my_int *edgecut, idxtype *part)
{
  my_int i, j;
  GraphType graph;
  CtrlType ctrl;
...
* for the target partitions
**************************************************************************/
void METIS_mCPartGraphRecursiveInternal(my_int *nvtxs, my_int *ncon, idxtype *xadj, idxtype *adjncy, 
       float *nvwgt, idxtype *adjwgt, my_int *nparts, my_int *options, my_int *edgecut, idxtype *part)
{
  my_int i, j;
  GraphType graph;
  CtrlType ctrl;
...
* for the target partitions
**************************************************************************/
void METIS_mCHPartGraphRecursiveInternal(my_int *nvtxs, my_int *ncon, idxtype *xadj, idxtype *adjncy, 
       float *nvwgt, idxtype *adjwgt, my_int *nparts, float *ubvec, my_int *options, my_int *edgecut, 
       idxtype *part)
{
  my_int i, j;
  GraphType graph;
...
**************************************************************************/
my_int MCMlevelRecursiveBisection(CtrlType *ctrl, GraphType *graph, my_int nparts, idxtype *part, 
       float ubfactor, my_int fpart)
{
  my_int i, j, nvtxs, ncon, cut;
  idxtype *label, *where;
...
* This function takes a graph and produces a bisection of it
**************************************************************************/
my_int MCHMlevelRecursiveBisection(CtrlType *ctrl, GraphType *graph, my_int nparts, idxtype *part, 
      float *ubvec, my_int fpart)
{
  my_int i, j, nvtxs, ncon, cut;
  idxtype *label, *where;
  GraphType lgraph, rgraph;

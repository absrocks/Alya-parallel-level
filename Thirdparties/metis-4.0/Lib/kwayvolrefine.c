...
**************************************************************************/
void RefineVolKWay(CtrlType *ctrl, GraphType *orggraph, GraphType *graph, my_int nparts, 
...
**************************************************************************/
void AllocateVolKWayPartitionMemory(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int nvtxs, pad64;
...
**************************************************************************/
void ComputeVolKWayPartitionParams(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
...
* This function computes the initial id/ed 
**************************************************************************/
void ComputeKWayVolGains(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, ii, j, k, kk, l, nvtxs, me, other, pid, myndegrees; 
...
**************************************************************************/
void ProjectVolKWayPartition(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, j, k, nvtxs, me, other, istart, iend, ndegrees;
...
**************************************************************************/
void ComputeVolKWayBoundary(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, nvtxs, nbnd;
...
* This function computes the boundary definition for balancing
**************************************************************************/
void ComputeVolKWayBalanceBoundary(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, nvtxs, nbnd;
  idxtype *bndind, *bndptr;

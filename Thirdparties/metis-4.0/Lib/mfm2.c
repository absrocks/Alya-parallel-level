...
**************************************************************************/ 
void SelectQueue2(my_int ncon, float *npwgts, float *tpwgts, my_int *from, my_int *cnum, 
       PQueueType queues[MAXNCON][2], float *maxwgt)
{
  my_int i, j, maxgain=0;
...
* ubvector ubvec
**************************************************************************/
my_int IsBetter2wayBalance(my_int ncon, float *newbal, float *oldbal, float *ubvec)
{
  my_int i, j;

...
**************************************************************************/
void MCRandom_KWayEdgeRefineHorizontal(CtrlType *ctrl, GraphType *graph, my_int nparts, 
       float *orgubvec, my_int npasses)
{
  my_int i, ii, iii, j, jj, k, l, pass, nvtxs, ncon, nmoves, nbnd, myndegrees, same; 
  my_int from, me, to, oldcut, gain;
...
* This function performs k-way refinement
**************************************************************************/
void MCGreedy_KWayEdgeBalanceHorizontal(CtrlType *ctrl, GraphType *graph, my_int nparts, 
       float *ubvec, my_int npasses)
{
  my_int i, ii, iii, j, jj, k, l, pass, nvtxs, ncon, nbnd, myndegrees, oldgain, gain, nmoves; 
  my_int from, me, to, oldcut;
  idxtype *xadj, *adjncy, *adjwgt;
...
**************************************************************************/
my_int AreAllHVwgtsBelow(my_int ncon, float alpha, float *vwgt1, float beta, float *vwgt2, float *limit)
{
  my_int i;
...
* a given set of values
**************************************************************************/
my_int AreAllHVwgtsAbove(my_int ncon, float alpha, float *vwgt1, float beta, float *vwgt2, float *limit)
{
  my_int i;
...
**************************************************************************/ 
void ComputeHKWayLoadImbalance(my_int ncon, my_int nparts, float *npwgts, float *lbvec)
{
  my_int i, j;
  float max;
...
**************************************************************************/
my_int MocIsHBalanced(my_int ncon, my_int nparts, float *npwgts, float *ubvec)
{
  my_int i, j;
  float max;
...
**************************************************************************/
my_int IsHBalanceBetterFT(my_int ncon, my_int nparts, float *pfrom, float *pto, float *vwgt, float *ubvec)
{
  my_int i, j, k;
...
**************************************************************************/
my_int IsHBalanceBetterTT(my_int ncon, my_int nparts, float *pt1, float *pt2, float *vwgt, float *ubvec)
{
  my_int i;

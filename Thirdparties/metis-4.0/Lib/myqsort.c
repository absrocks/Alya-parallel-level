...
static void iiqst(my_int *, my_int *);
...
**************************************************************************/
void iidxsort(my_int n, idxtype *base)
{
  register idxtype *i;
  register idxtype *j;
  register idxtype *lo;
...
/*************************************************************************
* Entry point of my_int increasing sort
**************************************************************************/
void iintsort(my_int n, my_int *base)
{
  register my_int *i;
  register my_int *j;
  register my_int *lo;
...
static void iiqst(my_int *base, my_int *max)
{
  register my_int *i;
  register my_int *j;
  register my_int *jj;
...
**************************************************************************/
void ikeysort(my_int n, KeyValueType *base)
{
...
**************************************************************************/
void ikeyvalsort(my_int n, KeyValueType *base)
{
  register KeyValueType *i;
  register KeyValueType *j;
  register KeyValueType *lo;

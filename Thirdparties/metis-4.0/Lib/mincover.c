...
**************************************************************************/
void MinCover(idxtype *xadj, idxtype *adjncy, my_int asize, my_int bsize, idxtype *cover, my_int *csize)
{
  my_int i, j;
  idxtype *mate, *queue, *flag, *level, *lst;
  my_int fptr, rptr, lstptr;
  my_int row, maxlevel, col;
...
**************************************************************************/
my_int MinCover_Augment(idxtype *xadj, idxtype *adjncy, my_int col, idxtype *mate, idxtype *flag, idxtype *level, my_int maxlevel)
{
  my_int i;
  my_int row = -1;
  my_int status;
...
**************************************************************************/
void MinCover_Decompose(idxtype *xadj, idxtype *adjncy, my_int asize, my_int bsize, idxtype *mate, idxtype *cover, my_int *csize)
{
  my_int i, k;
  idxtype *where;
  my_int card[10];
...
**************************************************************************/
void MinCover_ColDFS(idxtype *xadj, idxtype *adjncy, my_int root, idxtype *mate, idxtype *where, my_int flag)
{
  my_int i;
...
* forming alternate paths
**************************************************************************/
void MinCover_RowDFS(idxtype *xadj, idxtype *adjncy, my_int root, idxtype *mate, idxtype *where, my_int flag)
{
  my_int i;

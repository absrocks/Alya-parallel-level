...
**************************************************************************/
void FM_2WayNodeRefine(CtrlType *ctrl, GraphType *graph, float ubfactor, my_int npasses)
{
  my_int i, ii, j, k, jj, kk, nvtxs, nbnd, nswaps, nmind;
  idxtype *xadj, *vwgt, *adjncy, *where, *pwgts, *edegrees, *bndind, *bndptr;
  idxtype *mptr, *mind, *moved, *swaps, *perm;
  PQueueType parts[2]; 
  NRInfoType *rinfo;
  my_int higain, oldgain, mincut, initcut, mincutorder;	
  my_int pass, to, other, limit;
  my_int badmaxpwgt, mindiff, newdiff;
  my_int u[2], g[2];
  ...
  badmaxpwgt = (my_int)(ubfactor*(pwgts[0]+pwgts[1]+pwgts[2])/2);
...
* This function performs a node-based FM refinement 
**************************************************************************/
void FM_2WayNodeRefine2(CtrlType *ctrl, GraphType *graph, float ubfactor, my_int npasses)
{
  my_int i, ii, j, k, jj, kk, nvtxs, nbnd, nswaps, nmind;
  idxtype *xadj, *vwgt, *adjncy, *where, *pwgts, *edegrees, *bndind, *bndptr;
  idxtype *mptr, *mind, *moved, *swaps, *perm;
  ...
  for (pass=0; pass<npasses; pass++) {
    ...
    *******************************************************/
    ...
    to = (pwgts[0] < pwgts[1] ? 0 : 1);
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      badmaxpwgt = (my_int)(ubfactor*(pwgts[0]+pwgts[1]+pwgts[2]/2)/2);
...
* This function performs a node-based FM refinement 
**************************************************************************/
void FM_2WayNodeRefineEqWgt(CtrlType *ctrl, GraphType *graph, my_int npasses)
{
  my_int i, ii, j, k, jj, kk, nvtxs, nbnd, nswaps, nmind;
  idxtype *xadj, *vwgt, *adjncy, *where, *pwgts, *edegrees, *bndind, *bndptr;
  idxtype *mptr, *mind, *moved, *swaps, *perm;
...
* one-way version 
**************************************************************************/
void FM_2WayNodeRefine_OneSided(CtrlType *ctrl, GraphType *graph, float ubfactor, my_int npasses)
{
  my_int i, ii, j, k, jj, kk, nvtxs, nbnd, nswaps, nmind;
  idxtype *xadj, *vwgt, *adjncy, *where, *pwgts, *edegrees, *bndind, *bndptr;
...
{
  my_int i, ii, j, k, jj, kk, nvtxs, nbnd, nswaps;
  idxtype *xadj, *vwgt, *adjncy, *where, *pwgts, *edegrees, *bndind, *bndptr;
  idxtype *perm, *moved;
  PQueueType parts; 
  NRInfoType *rinfo;
  my_int higain, oldgain;	
  my_int pass, to, other;
  ...
  if (abs(pwgts[0]-pwgts[1]) < (my_int)((ubfactor-1.0)*(pwgts[0]+pwgts[1])))
    return;
...
**************************************************************************/
my_int ComputeMaxNodeGain(my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt)
{
  my_int i, j, k, max;

...
**************************************************************************/
void AllocateWorkSpace(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
...
**************************************************************************/
my_int WspaceAvail(CtrlType *ctrl)
{
...
**************************************************************************/
idxtype *idxwspacemalloc(CtrlType *ctrl, my_int n)
{
...
**************************************************************************/
void idxwspacefree(CtrlType *ctrl, my_int n)
{
  n += n%2; /* This is a fix for 64 bit machines that require 8-byte pointer allignment */
...
* This function allocate space from the core 
**************************************************************************/
float *fwspacemalloc(CtrlType *ctrl, my_int n)
{
  n += n%2; /* This is a fix for 64 bit machines that require 8-byte pointer allignment */
...
* This function frees space from the core 
**************************************************************************/
void fwspacefree(CtrlType *ctrl, my_int n)
{
  n += n%2; /* This is a fix for 64 bit machines that require 8-byte pointer allignment */

...
**************************************************************************/
void METIS_PartGraphVKway(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                         idxtype *vsize, my_int *wgtflag, my_int *numflag, my_int *nparts, 
                         my_int *options, my_int *volume, idxtype *part)
{
  my_int i;
  float *tpwgts;
...
**************************************************************************/
void METIS_WPartGraphVKway(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                          idxtype *vsize, my_int *wgtflag, my_int *numflag, my_int *nparts, 
                          float *tpwgts, my_int *options, my_int *volume, idxtype *part)
{
  my_int i, j;
  GraphType graph;
  CtrlType ctrl;
...
**************************************************************************/
my_int MlevelVolKWayPartitioning(CtrlType *ctrl, GraphType *graph, my_int nparts, idxtype *part, 

...
/*                                                                 */
/*  Id : $Id: XdmfTopology.cxx,v 1.27 2010-03-29 17:21:09 kwleiter Exp $  */
/*  Date : $Date: 2010-03-29 17:21:09 $ */
...
XdmfInt32
XdmfTopology::Build(){
    XdmfDebug("Building Topology");
    if(XdmfElement::Build() != XDMF_SUCCESS) return(XDMF_FAIL);
    if (this->IsReference) return(XDMF_SUCCESS);
    this->Set("TopologyType", this->GetTopologyTypeAsString());
    if ((this->TopologyType == XDMF_POLYVERTEX) || (this->TopologyType == XDMF_POLYLINE) ||
        (this->TopologyType == XDMF_POLYGON)) {
      /* NodesPerElement for POLY* elements */
      std::stringstream nodesPerElement;
      nodesPerElement << this->GetNodesPerElement();
      this->Set("NodesPerElement", nodesPerElement.str().c_str());
    }
    if(this->GetNumberOfElements()){
        /* NumberOfElements syntax preferred */
...
if(!Attribute) Attribute = this->Get( "Dimensions" );
if( Attribute ){

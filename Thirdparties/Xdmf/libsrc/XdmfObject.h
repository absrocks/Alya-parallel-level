...
typedef XDMF_64_U_INT  XdmfUInt64;
...
typedef unsigned long long XdmfUInt64;
...
#else
#define XdmfBoolean     int
#define XdmfString      char*
#define XdmfConstString const char*
#define XdmfPointer     void*
#define XdmfUInt8       unsigned char
#define XdmfUInt16      unsigned short
#define XdmfUInt32      unsigned int
#define XdmfUInt64      unsigned long long
#define XdmfInt8        char
#define XdmfInt16       short
#define XdmfInt32       int
#define XdmfInt64       long long
#define XdmfFloat32     float
#define XdmfFloat64     double

#define XdmfByte        unsigned char
#define XdmfLength      long long
#endif
...
#define XdmfSetPointerMacro(var,type) \
XdmfInt32 Set##var (type _arg) \
  { \
  if ((this->var##IsMine) && (this->var)) delete this->var; \
  this->var = _arg; \
  return ( XDMF_SUCCESS ); \
  }

...
/*                                                                 */
/*  Id : $Id: XdmfTopology.h,v 1.13 2010-03-24 20:03:48 kwleiter Exp $  */
...
#define XDMF_IS_STRUCTURED  0x100 // Mask to know if topology is XDMF_STRUCTURED
...
*/
  XdmfInt32 GetClass ( void ) {
    if( ( this->TopologyType & XDMF_IS_STRUCTURED ) == 0  ) {
...
protected:
  ...
  XdmfArray  *Connectivity; // Define array asociated with connectivity in DataItem element
  XdmfArray  *CellOffsets;
  XdmfInt32  OrderIsDefault;
  XdmfInt32  ConnectivityIsMine;
  XdmfInt32  BaseOffset;
  XdmfDataDesc  *Shape;   // Defines NumberOfElements attribute

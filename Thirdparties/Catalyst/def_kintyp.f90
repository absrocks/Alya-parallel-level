module def_kintyp
  ...
  type soltyp
     ...
     integer(ip)          :: nseqn
     integer(ip)          :: nrhss
     integer(ip)          :: kfl_exist          ! If solver exists
     ...
     ! RAS preconditioner
     !
     integer(ip), pointer :: iLras(:)
     integer(ip), pointer :: jLras(:)
     integer(ip), pointer :: iUras(:)
     integer(ip), pointer :: jUras(:)    
     real(rp),    pointer :: Lnras(:)    
     real(rp),    pointer :: Unras(:)      
     integer(ip), pointer :: ia_ras(:)
     integer(ip), pointer :: ja_ras(:)
     integer(ip), pointer :: permRras(:)
     integer(ip), pointer :: invpRras(:)
     integer(ip), pointer :: invpCras(:)
     real(rp),    pointer :: Aras(:,:,:)         
     !

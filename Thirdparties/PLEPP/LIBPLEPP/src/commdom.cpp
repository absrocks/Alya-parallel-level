...
//-----------------------------------------------------------------------||---//
void
CommDom::__simple_interpolation__(int cs_type, double tol, double* coords, int* vertices, double* point, double* shapef)  // 2016Mar22
{
  if(element_type==4)
  {
...
//int
void
CommDom::__hexa_interpolation__(double* vertex_coords, int* element_vertex_num, double* point_coords, double* shapef)
{

...
for line in fCoord:
    ...
    mf = mf1 + mf2
    Yc  = np.interp([mf], flamelet[:,zCol][correctOrd], flamelet[:,ycCol][correctOrd] )[0]
    rho = np.interp([mf], flamelet[:,zCol][correctOrd], flamelet[:,rhoCol][correctOrd] )[0]
    ...
    #--| H_f:                      -4672509.67135
    #--| H_ox:                     -10205.8103954
    H = mf * (-4672509.67135) + (1-mf) * (-10205.8103954)

...
#ALYAPATH="/Users/gguillamet/BSC/alya/214-solidz-sherloc"
ALYAPATH="/Users/gguillamet/BSC/alya/518-tw-scheme"
#
# MareNostrum
#
#ALYAPATH="/home/bsc21/bsc21946/alya/master"
#ALYAPATH="/home/bsc21/bsc21946/alya/214-solidz-sherloc"
#ALYAPATH="/home/bsc21/bsc21946/alya/518-tw-scheme"
...
if [ $1 == 'clean' ]; then
    ...
    mpirun -np $5 $ALYAPATH/Executables/plepp/Alya.g $1 --name $2 : -np $5 $ALYAPATH/Executables/plepp/Alya.g $3 --name $4 #| tee screen-$DATE.txt

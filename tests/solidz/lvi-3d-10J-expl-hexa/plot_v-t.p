...
plot "alya-sets-seq-ref.txt" using ($1*1e+3):(-1e-3*$3) title 'ALYA Ref.' with lines ls 1, \
     "alya-sets.out" using ($1*1e+3):(-1e-3*$3) title 'ALYA current' with lines ls 2

...
plot "alya-sets-seq.txt" using ($1*1e+3):(14-0.5*2e-6*$3*$3) title 'ALYA 3D (seq)' with lines ls 1, \
     "alya-sets.out" using ($1*1e+3):(14-0.5*2e-6*$3*$3) title 'ALYA 3D' with lines ls 2

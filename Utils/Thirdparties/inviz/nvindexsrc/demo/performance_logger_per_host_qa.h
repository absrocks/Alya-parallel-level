...
#ifndef NVIDIA_INDEX_BIN_GEOSPATIAL_STREAM_VIEWER_PERFORMANCE_LOGGER_PER_HOST_QA_H
#define NVIDIA_INDEX_BIN_GEOSPATIAL_STREAM_VIEWER_PERFORMANCE_LOGGER_PER_HOST_QA_H
...
/// - Output format: qa 
class Performance_logger_per_host_qa : public Performance_logger_base
{
public:
    /// constructor
    Performance_logger_per_host_qa();
    /// destructor
    virtual ~Performance_logger_per_host_qa();
...
private:
    ...
    /// performance type name -> value map
    std::map<std::string, std::string> m_performance_key_value_map;

private:
    /// copy constructor. prohibit until proved useful.
    Performance_logger_per_host_qa(Performance_logger_per_host_qa const &);
    /// operator=. prohibit until proved useful.
    Performance_logger_per_host_qa const & operator=(Performance_logger_per_host_qa const &);
};

//======================================================================
#endif // NVIDIA_INDEX_BIN_GEOSPATIAL_STREAM_VIEWER_PERFORMANCE_LOGGER_PER_HOST_QA_H

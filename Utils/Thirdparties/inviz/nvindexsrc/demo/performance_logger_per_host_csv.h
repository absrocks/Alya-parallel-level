...
#ifndef NVIDIA_INDEX_BIN_GEOSPATIAL_STREAM_VIEWER_PERFORMANCE_LOGGER_PER_HOST_CSV_H
#define NVIDIA_INDEX_BIN_GEOSPATIAL_STREAM_VIEWER_PERFORMANCE_LOGGER_PER_HOST_CSV_H
...
/// - Output format: csv 
class Performance_logger_per_host_csv : public Performance_logger_base
{
public:
    /// constructor
    Performance_logger_per_host_csv();
    /// destructor
    virtual ~Performance_logger_per_host_csv();
...
private:
    ...
    Performance_logger_per_host_csv(Performance_logger_per_host_csv const &);
    /// operator=. prohibit until proved useful.
    Performance_logger_per_host_csv const & operator=(Performance_logger_per_host_csv const &);
};

//======================================================================
#endif // NVIDIA_INDEX_BIN_GEOSPATIAL_STREAM_VIEWER_PERFORMANCE_LOGGER_PER_HOST_CSV_H

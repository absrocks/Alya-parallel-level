...
{
  my_int i, ii, j, k, nvtxs, ncon, cnvtxs, maxidx;
...
{
  my_int i, ii, j, k, l, nvtxs, cnvtxs, ncon, maxidx, maxwgt;
  idxtype *xadj, *adjncy, *adjwgt;
  idxtype *match, *cmap, *perm;
  float *nvwgt;
...
{
  my_int i, ii, j, k, nvtxs, cnvtxs, ncon, maxidx, maxwgt, avgdegree;
  idxtype *xadj, *adjncy, *adjwgt;
...
* This function finds a matching using the HEM heuristic
**************************************************************************/
void MCMatch_SHEBM(CtrlType *ctrl, GraphType *graph, my_int norm)
{
  my_int i, ii, j, k, nvtxs, cnvtxs, ncon, maxidx, maxwgt, avgdegree;
  idxtype *xadj, *adjncy, *adjwgt;
  idxtype *match, *cmap, *degrees, *perm, *tperm;
...
* This function finds a matching using the HEM heuristic
**************************************************************************/
void MCMatch_SBHEM(CtrlType *ctrl, GraphType *graph, my_int norm)
{
  my_int i, ii, j, k, nvtxs, cnvtxs, ncon, maxidx, maxwgt, avgdegree;
  idxtype *xadj, *adjncy, *adjwgt;
  idxtype *match, *cmap, *degrees, *perm, *tperm;
...
* vector that v+u1
**************************************************************************/
float BetterVBalance(my_int ncon, my_int norm, float *vwgt, float *u1wgt, float *u2wgt)
{
  my_int i;
...
**************************************************************************/
my_int AreAllVwgtsBelowFast(my_int ncon, float *vwgt1, float *vwgt2, float limit)
{
  my_int i;

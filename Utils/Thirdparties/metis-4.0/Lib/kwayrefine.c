...
**************************************************************************/
void RefineKWay(CtrlType *ctrl, GraphType *orggraph, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor)
{
  my_int i, nlevels, mustfree=0;
  GraphType *ptr;
...
**************************************************************************/
void AllocateKWayPartitionMemory(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int nvtxs, pad64;
...
**************************************************************************/
void ComputeKWayPartitionParams(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, j, k, l, nvtxs, nbnd, mincut, me, other;
...
**************************************************************************/
void ProjectKWayPartition(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, j, k, nvtxs, nbnd, me, other, istart, iend, ndegrees;
...
* contraints
**************************************************************************/
my_int IsBalanced(idxtype *pwgts, my_int nparts, float *tpwgts, float ubfactor)
{
  my_int i, j, tvwgt;
...
**************************************************************************/
void ComputeKWayBoundary(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, nvtxs, nbnd;
...
* This function computes the boundary definition for balancing
**************************************************************************/
void ComputeKWayBalanceBoundary(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, nvtxs, nbnd;
  idxtype *bndind, *bndptr;

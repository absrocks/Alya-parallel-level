...
**************************************************************************/
#ifdef __VC__
#define RandomInRange(u) ((lrand48()>>3)%(u))
#define RandomInRangeFast(u) ((lrand48()>>3)%(u))
#else
#define RandomInRange(u) ((my_int)(drand48()*((double)(u))))
#define RandomInRangeFast(u) ((lrand48()>>3)%(u))
#endif
...
**************************************************************************/
#ifdef DMALLOC
#define imalloc(n, msg) (malloc(sizeof(my_int)*(n)))
#define fmalloc(n, msg) (malloc(sizeof(float)*(n)))
#define idxmalloc(n, msg) (malloc(sizeof(idxtype)*(n)))
#define ismalloc(n, val, msg) (iset((n), (val), malloc(sizeof(my_int)*(n))))

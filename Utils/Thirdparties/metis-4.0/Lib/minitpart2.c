...
{
  my_int i, ii, j, k, l, kwgt, nvtxs, nbnd, ncon, nswaps, from, to, pass, me, cnum, tmp, imin;
...
**************************************************************************/ 
my_int SelectQueueOneWay2(my_int ncon, float *pto, PQueueType queues[MAXNCON][2], float *ubvec)
{
  my_int i, cnum=-1, imax, maxgain;
  float max=0.0;
  float twgt[MAXNCON];

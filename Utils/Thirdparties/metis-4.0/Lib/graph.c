...
**************************************************************************/
void SetUpGraph(GraphType *graph, my_int OpType, my_int nvtxs, my_int ncon,
       idxtype *xadj, idxtype *adjncy, idxtype *vwgt, idxtype *adjwgt, my_int wgtflag)
{
  my_int i, j, k, sum, gsize;
  float *nvwgt;
...
* This function sets up the graph from the user input
**************************************************************************/
void SetUpGraphKway(GraphType *graph, my_int nvtxs, idxtype *xadj, idxtype *adjncy)
{
  my_int i;
...
* This function sets up the graph from the user input
**************************************************************************/
void SetUpGraph2(GraphType *graph, my_int nvtxs, my_int ncon, idxtype *xadj, 
...
* This function sets up the graph from the user input
**************************************************************************/
void VolSetUpGraph(GraphType *graph, my_int OpType, my_int nvtxs, my_int ncon, idxtype *xadj, 
                   idxtype *adjncy, idxtype *vwgt, idxtype *vsize, my_int wgtflag)
{
  my_int i, j, k, sum, gsize;
  idxtype *adjwgt;
  float *nvwgt;
...
**************************************************************************/
my_int IsConnectedSubdomain(CtrlType *ctrl, GraphType *graph, my_int pid, my_int report)
{
  my_int i, j, k, nvtxs, first, last, nleft, ncmps, wgt;
...
**************************************************************************/
my_int IsConnected(CtrlType *ctrl, GraphType *graph, my_int report)
{
  my_int i, j, k, nvtxs, first, last;
...
* This function checks whether or not partition pid is contigous
**************************************************************************/
my_int IsConnected2(GraphType *graph, my_int report)
{
  my_int i, j, k, nvtxs, first, last, nleft, ncmps, wgt;
  idxtype *xadj, *adjncy, *where, *touched, *queue;
  idxtype *cptr;
...
**************************************************************************/
my_int FindComponents(CtrlType *ctrl, GraphType *graph, idxtype *cptr, idxtype *cind)
{
  my_int i, j, k, nvtxs, first, last, nleft, ncmps, wgt;
  idxtype *xadj, *adjncy, *where, *touched, *queue;

...
{
  my_int i, j, k, nedges, nlevels;
  float vfraction, efraction, vmult, emult;
  my_int coresize, gdata, rdata;
  ...
  nlevels = (my_int)(log(100.0/(*nvtxs))/log(vfraction) + .5);
...
**************************************************************************/
void EstimateCFraction(my_int nvtxs, idxtype *xadj, idxtype *adjncy, float *vfraction, float *efraction)
{
  my_int i, ii, j, cnvtxs, cnedges, maxidx;
...
**************************************************************************/
my_int ComputeCoarseGraphSize(my_int nvtxs, idxtype *xadj, idxtype *adjncy, my_int cnvtxs, idxtype *cmap, idxtype *match, idxtype *perm)
{
  my_int i, j, k, istart, iend, nedges, cnedges, v, u;
  idxtype *htable;

...
**************************************************************************/
void genmmd(my_int neqns, idxtype *xadj, idxtype *adjncy, idxtype *invp, idxtype *perm,
     my_int delta, idxtype *head, idxtype *qsize, idxtype *list, idxtype *marker,
     my_int maxint, my_int *ncsub)
{
    my_int  ehead, i, mdeg, mdlmt, mdeg_node, nextmd, num, tag;
...
***************************************************************************/
void mmdelm(my_int mdeg_node, idxtype *xadj, idxtype *adjncy, idxtype *head, idxtype *forward,
     idxtype *backward, idxtype *qsize, idxtype *list, idxtype *marker, my_int maxint,my_int tag)
{
    my_int   element, i,   istop, istart, j,
          jstop, jstart, link,
...
*       marker -- marker vector.
****************************************************************************/
my_int  mmdint(my_int neqns, idxtype *xadj, idxtype *adjncy, idxtype *head, idxtype *forward,
     idxtype *backward, idxtype *qsize, idxtype *list, idxtype *marker)
{
    my_int  fnode, ndeg, node;
...
****************************************************************************/
void mmdnum(my_int neqns, idxtype *perm, idxtype *invp, idxtype *qsize)
{
  my_int father, nextf, node, nqsize, num, root;
...
*    *tag   -- tag value.
****************************************************************************/
void mmdupd(my_int ehead, my_int neqns, idxtype *xadj, idxtype *adjncy, my_int delta, my_int *mdeg,
     idxtype *head, idxtype *forward, idxtype *backward, idxtype *qsize, idxtype *list,
     idxtype *marker, my_int maxint,my_int *tag)
{
 my_int  deg, deg0, element, enode, fnode, i, iq2, istop,

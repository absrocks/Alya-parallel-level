...
**************************************************************************/
void METIS_PartGraphRecursive(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
...
**************************************************************************/
void METIS_WPartGraphRecursive(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                               idxtype *adjwgt, my_int *wgtflag, my_int *numflag, my_int *nparts, 
...
**************************************************************************/
my_int MlevelRecursiveBisection(CtrlType *ctrl, GraphType *graph, my_int nparts, idxtype *part, float *tpwgts, float ubfactor, my_int fpart)
{
  my_int i, j, nvtxs, cut, tvwgt, tpwgts2[2];
  idxtype *label, *where;
...
**************************************************************************/
void MlevelEdgeBisection(CtrlType *ctrl, GraphType *graph, my_int *tpwgts, float ubfactor)
{
  GraphType *cgraph;
...
{
  my_int i, j, k, kk, l, istart, iend, mypart, nvtxs, ncon, snvtxs[2], snedges[2], sum;
...
**************************************************************************/
void SetUpSplitGraph(GraphType *graph, GraphType *sgraph, my_int snvtxs, my_int snedges)
{
  InitGraph(sgraph);
  sgraph->nvtxs = snvtxs;

...
**************************************************************************/
void METIS_EdgeND(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, my_int *numflag, my_int *options, 
...
**************************************************************************/
void METIS_NodeND(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, my_int *numflag, my_int *options, 
                  idxtype *perm, idxtype *iperm) 
{
  my_int i, ii, j, l, wflag, nflag;
  GraphType graph;
  CtrlType ctrl;
...
**************************************************************************/
void METIS_NodeWND(my_int *nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, my_int *numflag, 
                   my_int *options, idxtype *perm, idxtype *iperm) 
{
  my_int i, j, tvwgt;
  GraphType graph;
  CtrlType ctrl;
...
**************************************************************************/
void MlevelNestedDissection(CtrlType *ctrl, GraphType *graph, idxtype *order, float ubfactor, my_int lastvtx)
{
  my_int i, j, nvtxs, nbnd, tvwgt, tpwgts2[2];
...
* This function takes a graph and produces a bisection of it
**************************************************************************/
void MlevelNestedDissectionCC(CtrlType *ctrl, GraphType *graph, idxtype *order, float ubfactor, my_int lastvtx)
{
  my_int i, j, nvtxs, nbnd, tvwgt, tpwgts2[2], nsgraphs, ncmps, rnvtxs;
  idxtype *label, *bndind;
  idxtype *cptr, *cind;
  GraphType *sgraphs;
...
**************************************************************************/
void MlevelNodeBisectionMultiple(CtrlType *ctrl, GraphType *graph, my_int *tpwgts, float ubfactor)
{
  my_int i, nvtxs, cnvtxs, mincut, tmp;
  GraphType *cgraph; 
  idxtype *bestwhere;
...
**************************************************************************/
void MlevelNodeBisection(CtrlType *ctrl, GraphType *graph, my_int *tpwgts, float ubfactor)
{
  GraphType *cgraph;
...
{
  my_int i, ii, j, k, l, istart, iend, mypart, nvtxs, snvtxs[3], snedges[3];
...
**************************************************************************/
void MMDOrder(CtrlType *ctrl, GraphType *graph, idxtype *order, my_int lastvtx)
{
  my_int i, j, k, nvtxs, nofsub, firstvtx;
...
**************************************************************************/
my_int SplitGraphOrderCC(CtrlType *ctrl, GraphType *graph, GraphType *sgraphs, my_int ncmps, idxtype *cptr, idxtype *cind)
{
  my_int i, ii, iii, j, k, l, istart, iend, mypart, nvtxs, snvtxs, snedges;
  idxtype *xadj, *vwgt, *adjncy, *adjwgt, *adjwgtsum, *label, *where, *bndptr, *bndind;

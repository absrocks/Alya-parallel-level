...
**************************************************************************/
void MocRefineKWayHorizontal(CtrlType *ctrl, GraphType *orggraph, GraphType *graph, my_int nparts, 
       float *ubvec)
{
...
**************************************************************************/
void MocAllocateKWayPartitionMemory(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int nvtxs, ncon, pad64;
...
**************************************************************************/
void MocComputeKWayPartitionParams(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, j, k, l, nvtxs, ncon, nbnd, mincut, me, other;
...
**************************************************************************/
void MocProjectKWayPartition(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
...
**************************************************************************/
void MocComputeKWayBalanceBoundary(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, nvtxs, nbnd;

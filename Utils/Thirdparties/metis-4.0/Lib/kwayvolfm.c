...
**************************************************************************/
void Random_KWayVolRefine(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, 
                          float ubfactor, my_int npasses, my_int ffactor)
{
  my_int i, ii, iii, j, jj, k, kk, l, u, pass, nvtxs, nmoves, tvwgt, myndegrees, xgain; 
  my_int from, me, to, oldcut, oldvol, vwgt;
...
* This function performs k-way refinement
**************************************************************************/
void Random_KWayVolRefineMConn(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, 
            float ubfactor, my_int npasses, my_int ffactor)
{
  my_int i, ii, iii, j, jj, k, kk, l, u, pass, nvtxs, nmoves, tvwgt, myndegrees, xgain; 
  my_int from, me, to, oldcut, oldvol, vwgt, nadd, maxndoms;
  idxtype *xadj, *adjncy, *adjwgt;
  idxtype *where, *pwgts, *perm, *bndptr, *bndind, *minwgt, *maxwgt, *itpwgts, *updind, *marker, *phtable;
...
* This function performs k-way refinement
**************************************************************************/
void Greedy_KWayVolBalance(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, 
                           float ubfactor, my_int npasses)
{
  my_int i, ii, iii, j, jj, k, kk, l, u, pass, nvtxs, nmoves, tvwgt, myndegrees, xgain; 
  my_int from, me, to, vwgt, gain;
  idxtype *xadj, *adjncy, *adjwgt;
...
* This function performs k-way refinement
**************************************************************************/
void Greedy_KWayVolBalanceMConn(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, 
                                float ubfactor, my_int npasses)
{
  my_int i, ii, iii, j, jj, k, kk, l, u, pass, nvtxs, nmoves, tvwgt, myndegrees, xgain; 
  my_int from, me, to, vwgt, gain, maxndoms, nadd;
  idxtype *xadj, *adjncy, *adjwgt;
  idxtype *where, *pwgts, *perm, *moved, *bndptr, *bndind, *minwgt, *maxwgt, *itpwgts, *updind, *marker, *phtable;
  idxtype *pmat, *pmatptr, *ndoms;
  VEDegreeType *myedegrees;
...
**************************************************************************/
void KWayVolUpdate(CtrlType *ctrl, GraphType *graph, my_int v, my_int from, my_int to,
                   idxtype *marker, idxtype *phtable, idxtype *updind)
{
  my_int ii, iii, j, jj, k, kk, l, u, nupd, other, me, myidx; 
...
**************************************************************************/
void ComputeKWayVolume(GraphType *graph, my_int nupd, idxtype *updind, idxtype *marker, idxtype *phtable)
{
  my_int ii, iii, i, j, k, kk, l, nvtxs, me, other, pid;
  idxtype *xadj, *vsize, *adjncy, *adjwgt, *where;
...
**************************************************************************/
my_int ComputeVolume(GraphType *graph, idxtype *where)
{
  my_int i, j, k, me, nvtxs, nparts, totalv;
...
* This function computes the initial id/ed 
**************************************************************************/
void CheckVolKWayPartitionParams(CtrlType *ctrl, GraphType *graph, my_int nparts)
{
  my_int i, ii, j, k, kk, l, nvtxs, nbnd, mincut, minvol, me, other, pid;
...
**************************************************************************/
void ComputeVolSubDomainGraph(GraphType *graph, my_int nparts, idxtype *pmat, idxtype *ndoms)
{
  my_int i, j, k, me, nvtxs, ndegrees;
...
* This function computes the subdomain graph
**************************************************************************/
void EliminateVolSubDomainEdges(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts)
{
  my_int i, ii, j, k, me, other, nvtxs, total, max, avg, totalout, nind, ncand, ncand2, target, target2, nadd;
  my_int min, move, cpwgt, tvwgt;
...
* remove some of them
**************************************************************************/
void EliminateVolComponents(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor)
{
  my_int i, ii, j, jj, k, me, nvtxs, tvwgt, first, last, nleft, ncmps, cwgt, ncand, other, target, deltawgt;

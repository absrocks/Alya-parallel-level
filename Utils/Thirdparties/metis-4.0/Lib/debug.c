...
**************************************************************************/
my_int ComputeCut(GraphType *graph, idxtype *where)
{
  my_int i, j, cut;
...
**************************************************************************/
my_int CheckBnd(GraphType *graph) 
{
  my_int i, j, nvtxs, nbnd;
...
* This function checks whether or not the boundary information is correct
**************************************************************************/
my_int CheckBnd2(GraphType *graph) 
{
  my_int i, j, nvtxs, nbnd, id, ed;
  idxtype *xadj, *adjncy, *where, *bndptr, *bndind;
...
* This function checks whether or not the boundary information is correct
**************************************************************************/
my_int CheckNodeBnd(GraphType *graph, my_int onbnd) 
{
  my_int i, j, nvtxs, nbnd;
  idxtype *xadj, *adjncy, *where, *bndptr, *bndind;
...
**************************************************************************/
my_int CheckRInfo(RInfoType *rinfo)
{
  my_int i, j;
...
**************************************************************************/
my_int CheckNodePartitionParams(GraphType *graph)
{
  my_int i, j, k, l, nvtxs, me, other;
...
**************************************************************************/
my_int IsSeparable(GraphType *graph)
{
  my_int i, j, nvtxs, other;

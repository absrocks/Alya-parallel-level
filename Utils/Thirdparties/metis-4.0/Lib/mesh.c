...
* bricks.
******************************************************************************/
void METIS_MeshToDual(my_int *ne, my_int *nn, idxtype *elmnts, my_int *etype, my_int *numflag, 
                      idxtype *dxadj, idxtype *dadjncy)
{
  my_int esizes[] = {-1, 3, 4, 8, 4};
...
******************************************************************************/
void METIS_MeshToNodal(my_int *ne, my_int *nn, idxtype *elmnts, my_int *etype, my_int *numflag, 
                       idxtype *dxadj, idxtype *dadjncy)
{
  my_int esizes[] = {-1, 3, 4, 8, 4};
...
******************************************************************************/
void GENDUALMETIS(my_int nelmnts, my_int nvtxs, my_int etype, idxtype *elmnts, idxtype *dxadj, idxtype *dadjncy)
{
   my_int i, j, jj, k, kk, kkk, l, m, n, nedges, mask;
   idxtype *nptr, *nind;
   idxtype *mark, ind[200], wgt[200];
   my_int esize, esizes[] = {-1, 3, 4, 8, 4},
...
******************************************************************************/
void TRINODALMETIS(my_int nelmnts, my_int nvtxs, idxtype *elmnts, idxtype *dxadj, idxtype *dadjncy)
{
   my_int i, j, jj, k, kk, kkk, l, m, n, nedges;
   idxtype *nptr, *nind;
   idxtype *mark;
...
* This function creates the nodal graph of a finite element mesh
******************************************************************************/
void TETNODALMETIS(my_int nelmnts, my_int nvtxs, idxtype *elmnts, idxtype *dxadj, idxtype *dadjncy)
{
   my_int i, j, jj, k, kk, kkk, l, m, n, nedges;
   idxtype *nptr, *nind;
   idxtype *mark;
...
* This function creates the nodal graph of a finite element mesh
******************************************************************************/
void HEXNODALMETIS(my_int nelmnts, my_int nvtxs, idxtype *elmnts, idxtype *dxadj, idxtype *dadjncy)
{
   my_int i, j, jj, k, kk, kkk, l, m, n, nedges;
   idxtype *nptr, *nind;
   idxtype *mark;
   my_int table[8][3] = {1, 3, 4,
                      0, 2, 5,
                      1, 3, 6,
                      0, 2, 7,
                      0, 5, 7,
...
* This function creates the nodal graph of a finite element mesh
******************************************************************************/
void QUADNODALMETIS(my_int nelmnts, my_int nvtxs, idxtype *elmnts, idxtype *dxadj, idxtype *dadjncy)
{
   my_int i, j, jj, k, kk, kkk, l, m, n, nedges;
   idxtype *nptr, *nind;
   idxtype *mark;
   my_int table[4][2] = {1, 3, 
                      0, 2,
                      1, 3, 
                      0, 2}; 

...
**************************************************************************/
void METIS_mCPartGraphKway(my_int *nvtxs, my_int *ncon, idxtype *xadj, idxtype *adjncy, 
                          idxtype *vwgt, idxtype *adjwgt, my_int *wgtflag, my_int *numflag, 
                          my_int *nparts, float *rubvec, my_int *options, my_int *edgecut, 
                          idxtype *part)
{
  my_int i, j;
  GraphType graph;
...
**************************************************************************/
my_int MCMlevelKWayPartitioning(CtrlType *ctrl, GraphType *graph, my_int nparts, idxtype *part, 
      float *rubvec)
{
  my_int i, j, nvtxs;
  GraphType *cgraph;
  my_int options[10], edgecut;

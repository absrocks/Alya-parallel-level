...
{
  my_int i, j, k, nvtxs, ncon, from, bestcut, mincut, nbfs;
...
{
  my_int i, ii, j, k, nvtxs, ncon, from, bestcut, mincut, nbfs, qnum;
  idxtype *bestwhere, *where, *perm;
  my_int counts[MAXNCON];
  float *nvwgt;
...
{
  my_int i, ii, j, k, l, kwgt, nvtxs, nbnd, ncon, nswaps, from, to, pass, me, cnum, tmp;
  idxtype *xadj, *adjncy, *adjwgt, *where, *id, *ed, *bndptr, *bndind;
  idxtype *perm, *qnum;
  float *nvwgt, *npwgts;
  PQueueType parts[MAXNCON][2];
  my_int higain, oldgain, mincut;
...
**************************************************************************/ 
int SelectQueueOneWay(int ncon, float *npwgts, float *tpwgts, my_int from, PQueueType queues[MAXNCON][2])
{
  my_int i, cnum=-1;
  float max=0.0;

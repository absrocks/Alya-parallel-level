...
**************************************************************************/
void METIS_PartMeshNodal(my_int *ne, my_int *nn, idxtype *elmnts, my_int *etype, my_int *numflag, 
                         my_int *nparts, my_int *edgecut, idxtype *epart, idxtype *npart)
{
  my_int i, j, k, me;
  idxtype *xadj, *adjncy, *pwgts;
  my_int options[10], pnumflag=0, wgtflag=0;
  my_int nnbrs, nbrind[200], nbrwgt[200], maxpwgt;
...
**************************************************************************/
void METIS_PartMeshDual(my_int *ne, my_int *nn, idxtype *elmnts, my_int *etype, my_int *numflag, 
                        my_int *nparts, my_int *edgecut, idxtype *epart, idxtype *npart)
{
  my_int i, j, k, me;

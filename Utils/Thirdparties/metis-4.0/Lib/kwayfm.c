...
**************************************************************************/
void Random_KWayEdgeRefine(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor, my_int npasses, my_int ffactor)
{
...
* This function performs k-way refinement
**************************************************************************/
void Greedy_KWayEdgeRefine(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor, my_int npasses)
{
  my_int i, ii, iii, j, jj, k, l, pass, nvtxs, nbnd, tvwgt, myndegrees, oldgain, gain; 
  my_int from, me, to, oldcut, vwgt;
  idxtype *xadj, *adjncy, *adjwgt;
...
* This function performs k-way refinement
**************************************************************************/
void Greedy_KWayEdgeBalance(CtrlType *ctrl, GraphType *graph, my_int nparts, float *tpwgts, float ubfactor, my_int npasses)
{

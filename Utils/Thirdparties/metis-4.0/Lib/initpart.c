...
**************************************************************************/
void Init2WayPartition(CtrlType *ctrl, GraphType *graph, my_int *tpwgts, float ubfactor) 
{
  my_int dbglvl;
...
* graph->where
**************************************************************************/
void GrowBisection(CtrlType *ctrl, GraphType *graph, my_int *tpwgts, float ubfactor)
{
  my_int i, j, k, nvtxs, drain, nleft, first, last, pwgts[2], minpwgt[2], maxpwgt[2], from, bestcut, icut, mincut, me, pass, nbfs;
...
{
  my_int i, j, k, nvtxs, drain, nleft, first, last, pwgts[2], tpwgts[2], minpwgt[2], maxpwgt[2], from, bestcut, icut, mincut, me, pass, nbfs;
...
* graph->where
**************************************************************************/
void RandomBisection(CtrlType *ctrl, GraphType *graph, my_int *tpwgts, float ubfactor)
{
  my_int i, ii, j, k, nvtxs, pwgts[2], minpwgt[2], maxpwgt[2], from, bestcut, icut, mincut, me, pass, nbfs;
  idxtype *xadj, *vwgt, *adjncy, *adjwgt, *where;

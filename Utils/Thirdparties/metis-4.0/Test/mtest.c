...
* Let the game begin
**************************************************************************/
main(my_int argc, char *argv[])
{
  my_int i, nparts, options[10];
  idxtype *part;
  float lbvec[MAXNCON], rubvec[MAXNCON];
  GraphType graph;
  my_int numflag = 0, wgtflag = 0, edgecut;
...
**************************************************************************/
void Test_PartGraph(my_int nvtxs, idxtype *xadj, idxtype *adjncy)
{
  my_int i, j, jj, k, tstnum, rcode;
  my_int nparts, numflag, wgtflag, edgecut, options[10];
...
**************************************************************************/
my_int VerifyPart(my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
               idxtype *adjwgt, my_int nparts, my_int edgecut, idxtype *part)
{
  my_int i, j, k, cut, vfree=0, efree=0, rcode=0;
  idxtype *pwgts;
...
* This function verifies that the partitioning was computed correctly
**************************************************************************/
my_int VerifyWPart(my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                idxtype *adjwgt, my_int nparts, float *tpwgts, my_int edgecut, idxtype *part)
{
  my_int i, j, k, tvwgt, cut, vfree=0, efree=0, rcode=0;
  idxtype *pwgts;
...
* This function tests the regular graph partitioning routines
**************************************************************************/
void Test_PartGraphV(my_int nvtxs, idxtype *xadj, idxtype *adjncy)
{
  my_int i, j, jj, k, tstnum, rcode;
  my_int nparts, numflag, wgtflag, totalv, options[10];
...
* This function verifies that the partitioning was computed correctly
**************************************************************************/
my_int VerifyPartV(my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
               idxtype *vsize, my_int nparts, my_int totalv, idxtype *part)
{
  my_int i, j, k, ttlv, vfree=0, efree=0, rcode=0;
...
* This function verifies that the partitioning was computed correctly
**************************************************************************/
my_int VerifyWPartV(my_int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
                idxtype *vsize, my_int nparts, float *tpwgts, my_int totalv, idxtype *part)
{
  my_int i, j, k, tvwgt, ttlv, vfree=0, efree=0, rcode=0;
  idxtype *pwgts, *marker;
...
* This function tests the regular graph partitioning routines
**************************************************************************/
void Test_PartGraphmC(my_int nvtxs, idxtype *xadj, idxtype *adjncy)
{
  my_int i, j, jj, k, tstnum, rcode;
  my_int nparts, ncon, numflag, wgtflag, edgecut, options[10];
  idxtype *part, *vwgt, *adjwgt;
  float ubvec[MAXNCON];
...
* This function verifies that the partitioning was computed correctly
**************************************************************************/
my_int VerifyPartmC(my_int nvtxs, my_int ncon, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
               idxtype *adjwgt, my_int nparts, float *ubvec, my_int edgecut, idxtype *part)
{
  my_int i, j, k, cut, efree=0, rcode=0;
  idxtype *pwgts;
  float lb;
...
* This function tests the regular graph partitioning routines
**************************************************************************/
void Test_ND(my_int nvtxs, idxtype *xadj, idxtype *adjncy)
{
  my_int i, j, jj, k, tstnum, rcode;
  my_int numflag, wgtflag, options[10];
...
* This function verifies that the partitioning was computed correctly
**************************************************************************/
my_int VerifyND(my_int nvtxs, idxtype *perm, idxtype *iperm)
{
  my_int i, j, k, rcode=0;

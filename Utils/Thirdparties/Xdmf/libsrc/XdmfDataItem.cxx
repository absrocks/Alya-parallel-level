...
/*                                                                 */
/*  Id : $Id: XdmfDataItem.cxx,v 1.33 2010-03-16 17:33:38 kwleiter Exp $  */
...
XdmfInt32 XdmfDataItem::Build(){
    ...
    /* aDataDesc must not be this->Array, this->Array sets datadesc for local piece */
    /* This should be fixed if we want to use XDMF library to write H5 dataset in parallel */
    /* Right now, it has been left as original to work with parallelio support library */
    if(this->Array) aDataDesc = this->Array;
    /* However we must setup TYPE, SHAPE and SELECTION at some place */
    switch(this->ItemType) {
      case XDMF_ITEM_UNIFORM:
        // This is the default
        //this->Set("ItemType", "Uniform");
        //break;
      case XDMF_ITEM_HYPERSLAB:
        this->Set("ItemType", "Hyperslab");
        break;
      case XDMF_ITEM_COORDINATES:
        this->Set("ItemType", "Coordinates");
        break;
      case XDMF_ITEM_FUNCTION:
        this->Set("ItemType", "Function");
        break;
      case XDMF_ITEM_COLLECTION:
        this->Set("ItemType", "Collection");
        break;
      case XDMF_ITEM_TREE:
        this->Set("ItemType", "Tree");
        break;
      default:
        break;
    }
    if (this->ItemType == XDMF_ITEM_FUNCTION) this->Set("Function", Function);
    ...
    // No need to write anything for DataItem != Uniform
    if (this->ItemType != XDMF_ITEM_UNIFORM) return(XDMF_SUCCESS);
    if(this->CheckValues(this->Format) != XDMF_SUCCESS){
        XdmfErrorMessage("Error Accessing Internal XdmfValues");
        return(XDMF_FAIL);
    }

...
/*                                                                 */
/*  Id : $Id: XdmfArray.cxx,v 1.18 2010-03-24 20:03:48 kwleiter Exp $  */
        ...
        XdmfInt64 ValuesStride ) 
{
  switch(Values->GetNumberType())
  {
    ...
    case(XDMF_UINT64_TYPE):
      return this->SetValues(Index, (XdmfUInt64*)Values->GetDataPointer(ValuesStart), NumberOfValues, ArrayStride, ValuesStride);
    default:
      return this->SetValues(Index, (XdmfFloat64*)Values->GetDataPointer(ValuesStart), NumberOfValues, ArrayStride, ValuesStride);
  }
  return XDMF_FAIL;
...
XdmfInt32 XdmfArray::SetValues( XdmfInt64 Index, XdmfUInt64 *Values,
        XdmfInt64 NumberOfValues,
        XdmfInt64 ArrayStride,
        XdmfInt64 ValuesStride ) {
XdmfPointer  ArrayPointer;
...
XDMF_ARRAY_COPY( ArrayPointer, this->GetNumberType(), ArrayStride,
    Values, XDMF_UINT64_TYPE, ValuesStride,
    XDMF_ARRAY_IN, NumberOfValues );
return( XDMF_SUCCESS );
}
...
XdmfInt32 XdmfArray::GetValues( XdmfInt64 Index, XdmfUInt64 *Values,
        XdmfInt64 NumberOfValues,
        XdmfInt64 ArrayStride,
        XdmfInt64 ValuesStride ) {
XdmfPointer  ArrayPointer;
...
if( this->GetNumberType() == XDMF_INT8_TYPE   || this->GetNumberType() == XDMF_INT16_TYPE  ||
    this->GetNumberType() == XDMF_INT32_TYPE  || this->GetNumberType() == XDMF_INT64_TYPE  ||
    this->GetNumberType() == XDMF_UINT8_TYPE  || this->GetNumberType() == XDMF_UINT16_TYPE ||
    this->GetNumberType() == XDMF_UINT32_TYPE || this->GetNumberType() == XDMF_UINT64_TYPE) {

...
/*                                                                 */
/*  Id : $Id: XdmfArrayCopyMacro.h,v 1.2 2009-01-23 20:31:39 clarke Exp $  */
...
#define XDMF_ARRAY_COPY(\
    ...
    switch(ArrayType) { \
      ...
      case XDMF_UINT64_TYPE : \
        XdmfArrayCopy((XdmfUInt64*)ArrayPointer, ArrayStride, ValuePointer, ValueStride, Direction, NumberOfValues); \
        break; \
      case XDMF_INT8_TYPE : \
...
#define XDMF_ARRAY_OPERATE(OPERATOR, ArrayPointer, ArrayType, ArrayStride, ValuePointer, ValueType, ValueStride, Direction, NumberOfValues  ) \
    switch(ArrayType) { \
      ...
      case XDMF_UINT32_TYPE : \
        ...
        break; \
      case XDMF_UINT64_TYPE : \
        XdmfArrayOperate((XdmfUInt64*)ArrayPointer, ArrayStride, ValuePointer, ValueStride, Direction, NumberOfValues, (OPERATOR*)0); \
        break; \
      case XDMF_INT8_TYPE : \

...
/*                                                                 */
/*  Id : $Id: XdmfValuesXML.cxx,v 1.11 2009-08-05 21:42:12 kwleiter Exp $  */
/*  Date : $Date: 2009-08-05 21:42:12 $ */
...
XdmfValuesXML::Write(XdmfArray *anArray, XdmfConstString /*HeavyDataSetName*/){
    ...
    // Indent XML data depending on the number of ancestors
    nParents = GetNumberOfParents(this->GetElement());
    ...
    while(nelements){
        ...
        // Add indentation (we substract 1 because ROOT level)
        for (i = 0; i< nParents-1; i++)
          StringOutput << "  ";
    ...
    // Add indentation (we substract 2 because ROOT level + Parent)

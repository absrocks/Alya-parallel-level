...
subroutine solric(nbnodes,ndofn,rhsid,unkno,amatr,pmatr)
  use def_kintyp
  use def_master, only       :  INOTMASTER,INOTSLAVE,IMASTER
  use def_domain, only       :  c_dom,r_dom,c_sym,r_sym
  ...
  integer(ip)                        :: jnode,jpoin,itotn,jtotn,npoin
  integer(ip)                        :: idofn,ihang,ipoin,izdom,miter
  integer(ip)                        :: maxiter,nrows
  real(rp)                           :: fact1,xdiag,fact2,dummr,dumm2

...
subroutine ker_readat()
  ...
  integer(ip)  :: imodu,jmodu,idime,imate,ipara,ipoin,ifunc,kdime,iauxi,ii
  ...
  if( INOTSLAVE ) then
     ...
     kfl_kemod_ker =  0                                     ! kermod k eps model modification
     ...
     do while(words(1) /= 'ENDPH' )
        ...
        if(      words(1) == 'SUBDO' ) then
           ...
           !
           !.md<1>VELOCITY: OFF/HELIC/FUNCTION= int
           !.md<field>VELOCITY
           ...
           !.md<3>POROSITY:      CONSTANT/CANOPY/DAFOR,                        PARAMETERS= real1, real2..., DEFAULT_VALUE= real3
           ...
           !.md<3>TURBUL       : WALE/STDKE/STTKO,    UPDP1 = ENDITE/ENDINN/ENDSTE/DOITER/ENDBLCK/NEVER  UPDP2 = ENDITE/ENDINN/ENDSTE/DOITER/ENDBLCK/NEVER
           !.md<2>END_MATERIAL
           !.md<1>END_PROPERTIES
           !.md<field>PROPERTIES
           ...
           do while( words(1) /= 'ENDPR' )
              ...
              if( words(1) == 'DENSI' ) then
                 ...
                 !check parameters for canopy (H, CD, LAD, Zmax/h )
           ...
           !.md<1>WINKDK
           !.md<field>WINKDK
           !.md<com>(PRESSURE WINKDKESSEL MODEL) Pressure model to account for arterial networks

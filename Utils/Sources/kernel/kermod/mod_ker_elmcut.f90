...
contains
  ...
  subroutine ker_elmcut_free_surface()
    ...
    integer(ip)  :: jpoin,izdom,knode,idime,jdime,iedge,jedge
    ...
    real(rp)     :: x1,x2,fi,fj,t,norma(3),norma1(3),norma2(3),zeror
    real(rp)     :: xx(3,12),xx_avg(3),pcoor(3),dummr,max_fleve,min_fleve

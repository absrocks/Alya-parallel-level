  ...
  if( kfl_schur >= 1 .or. kfl_aiipr >= 1 ) then 
     ...
     if( IMASTER ) then
        ...
        if( onlyAii ) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'R_DOM_AII','par_schurr',r_dom_aii)      
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'C_DOM_AII','par_schurr',c_dom_aii)      
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'R_DOM_AIB','par_schurr',r_dom_aib)     
           allocate( r_dom_abi(npoin_bb+1) , stat = istat )
           call memchk(zero,istat,mem_servi(1:2,servi),'R_DOM_ABI','par_schurr',r_dom_abi)     
           allocate( r_dom_abb(npoin_bb+1) , stat = istat )
           call memchk(zero,istat,mem_servi(1:2,servi),'R_DOM_ABB','par_schurr',r_dom_abb)     
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'C_DOM_AIB','par_schurr',c_dom_aib)     
           allocate( c_dom_abi(nzdom_abi) , stat = istat )
           call memchk(zero,istat,mem_servi(1:2,servi),'C_DOM_ABI','par_schurr',c_dom_abi)     
           allocate( c_dom_abb(nzdom_abb) , stat = istat )
           call memchk(zero,istat,mem_servi(1:2,servi),'C_DOM_ABB','par_schurr',c_dom_abb)     

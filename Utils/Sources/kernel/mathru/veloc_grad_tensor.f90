...
!----------------------------------------------
  ...
  call jacobi_nre(G__ij,lambda,V,nrot,'VELOC_GRAD_TENSOR')
  ! Sorts the eigenvalues, lambda, into ascending order. 
  call eigsrt(lambda,V)
  lambda2=lambda(2)

...
module mod_elmgeo
  ...
  public :: list_faces_TRI06,type_faces_TRI06
  ...
  public :: list_faces_TET10,type_faces_TET10
...
contains
  ...
  subroutine elmgeo_element_type_initialization()
    ...
    element_type(BAR02) = elem_typ( 'BAR02' , 'Linear'        , 1_ip , 1_ip ,-1_ip , 2_ip , .false. , 1_ip , 2_ip , 1_ip , 2.0_rp, (/ 0.0_rp , 0.0_rp , 0.0_rp /), &
         &                           null(), null(), null(), null() , 0_ip, 0_ip, 0_ip, 0_ip, null(), null(), null(), null() )
    element_type(BAR03) = elem_typ( 'BAR03' , 'Linear'        , 1_ip , 2_ip ,-1_ip , 3_ip , .true.  , 1_ip , 2_ip , 0_ip , 2.0_rp, (/ 0.0_rp , 0.0_rp , 0.0_rp /), &
         &                           null(), null(), null(), null() , 0_ip, 0_ip, 0_ip, 0_ip, null(), null(), null(), null() )
    element_type(BAR04) = elem_typ( 'BAR04' , 'Linear'        , 1_ip , 3_ip ,-1_ip , 4_ip , .true.  , 1_ip , 2_ip , 0_ip , 2.0_rp, (/ 0.0_rp , 0.0_rp , 0.0_rp /), &
         &                           null(), null(), null(), null() , 0_ip, 0_ip, 0_ip, 0_ip, null(), null(), null(), null() )
  ...
  subroutine elmgeo_segpla(ndime,xplan,xcoo1,xcoo2,ifoun,plapo,toler_opt)
    ...
    ifoun = 0
    if( present(toler_opt) ) toler = toler_opt

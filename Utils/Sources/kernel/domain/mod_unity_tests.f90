...
module mod_unity_tests
  ...
  integer(ip), parameter :: max_order=10
...
10        continue
  ...
  subroutine unity_tests_polynomial_integration()
    ...
    do ielty = 1,6
       ...
       do pgaus = 1,100
          ...
          call rulepw(ndime,pgaus,prule,posgp,weigp,ierro)
  ...
  subroutine unity_tests_PEN18(ndime,nnode,npoin,nelem,lnods,coord)
    ...
    lnods(:,1) = (/ 1,2,4,5,6,7,9,13,12,17,18,19,14,15,16,23,24,25 /)
    lnods(:,2) = (/ 2,3,4,6,8,7,10,11,13,16,22,19,21,20,15,27,26,24 /)
    ...
    coord(:, 5) = (/ 0.0_rp , 0.0_rp , 1.0_rp /)
    coord(:, 6) = (/ 1.0_rp , 0.0_rp , 1.0_rp /)
    coord(:, 7) = (/ 0.0_rp , 1.0_rp , 1.0_rp /)
    coord(:, 8) = (/ 1.0_rp , 1.0_rp , 1.0_rp /)
    ...
    coord(:,15) = (/ 0.5_rp , 0.5_rp , 1.0_rp /)
    coord(:,16) = (/ 0.0_rp , 0.5_rp , 1.0_rp /)
    coord(:,17) = (/ 0.0_rp , 0.0_rp , 0.5_rp /)
    coord(:,18) = (/ 1.0_rp , 0.0_rp , 0.5_rp /)
    coord(:,19) = (/ 0.0_rp , 1.0_rp , 0.5_rp /)
    coord(:,20) = (/ 0.5_rp , 1.0_rp , 1.0_rp /)
    coord(:,21) = (/ 1.0_rp , 0.5_rp , 1.0_rp /)
    coord(:,22) = (/ 1.0_rp , 1.0_rp , 0.5_rp /)
    coord(:,23) = (/ 0.5_rp , 0.0_rp , 0.5_rp /)
    coord(:,24) = (/ 0.5_rp , 0.5_rp , 0.5_rp /)
    coord(:,25) = (/ 0.0_rp , 0.5_rp , 0.5_rp /)
    coord(:,26) = (/ 0.5_rp , 1.0_rp , 0.5_rp /)
    coord(:,27) = (/ 1.0_rp , 0.5_rp , 0.5_rp /)
  ...
  subroutine unity_tests_check_halos()
    ...
    use def_domain,         only : lnnob,lnnod

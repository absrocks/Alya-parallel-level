...
module mod_mpio_seq_iowrapper
    ...
    interface SEQ_FILE_READ
        module procedure                        SEQ_FILE_READ_INT4,&
                                                ...
                                                SEQ_FILE_READ_REAL4,&
                                                SEQ_FILE_READ_REAL4_V,&
                                                SEQ_FILE_READ_REAL4_M,&
#ifndef __PGI
                                                SEQ_FILE_READ_REAL16,&
                                                SEQ_FILE_READ_REAL16_V,&
                                                SEQ_FILE_READ_REAL16_M,&
#endif
                                                SEQ_FILE_READ_CHAR8,&
    ...
    interface SEQ_FILE_WRITE
        module procedure                        SEQ_FILE_WRITE_INT4,&
                                                ...
                                                SEQ_FILE_WRITE_REAL4,&
                                                SEQ_FILE_WRITE_REAL4_V,&
                                                SEQ_FILE_WRITE_REAL4_M,&
#ifndef __PGI
                                                SEQ_FILE_WRITE_REAL16,&
                                                SEQ_FILE_WRITE_REAL16_V,&
                                                SEQ_FILE_WRITE_REAL16_M,&
#endif
    ...
    subroutine SEQ_FILE_READ_REAL4(fh, buf)
        integer(ip),           intent(in)              :: fh
        real(4),               intent(inout)           :: buf
        read(fh) buf
    end subroutine

    subroutine SEQ_FILE_READ_REAL4_V(fh, buf, bsize)
        integer(ip),           intent(in)              :: fh
    ...
    subroutine SEQ_FILE_READ_REAL4_M(fh, buf, bsize1, bsize2)
        integer(ip),           intent(in)              :: fh
        real(4), pointer,      intent(inout)           :: buf(:,:)
        integer(ip),           intent(in)              :: bsize1, bsize2
        read(fh) buf(1:bsize1, 1:bsize2)
...
#ifndef __PGI
    subroutine SEQ_FILE_READ_REAL16(fh, buf)
        integer(ip),           intent(in)              :: fh
        real(16),              intent(inout)           :: buf
        read(fh) buf
    end subroutine

    subroutine SEQ_FILE_READ_REAL16_V(fh, buf, bsize)
        integer(ip),           intent(in)              :: fh
    ...
    subroutine SEQ_FILE_READ_REAL16_M(fh, buf, bsize1, bsize2)
        integer(ip),           intent(in)              :: fh
        real(16), pointer,     intent(inout)           :: buf(:,:)
        integer(ip),           intent(in)              :: bsize1, bsize2
        read(fh) buf(1:bsize1, 1:bsize2)
    ...
    subroutine SEQ_FILE_WRITE_INT4_M(fh, buf, bsize1, bsize2)
        ...
        integer(4), pointer,   intent(in)              :: buf(:,:)
        integer(ip),           intent(in)              :: bsize1, bsize2
        write(fh) buf(1:bsize1, 1:bsize2)
    end subroutine
    ...
    subroutine SEQ_FILE_WRITE_REAL4(fh, buf)
        integer(ip),           intent(in)              :: fh
        real(4),               intent(in)              :: buf
        write(fh) buf
    end subroutine

    subroutine SEQ_FILE_WRITE_REAL4_V(fh, buf, bsize)
        integer(ip),           intent(in)              :: fh
    ...
    subroutine SEQ_FILE_WRITE_REAL4_M(fh, buf, bsize1, bsize2)
        integer(ip),           intent(in)              :: fh
        real(4), pointer,      intent(in)              :: buf(:,:)
        integer(ip),           intent(in)              :: bsize1, bsize2
        write(fh) buf(1:bsize1, 1:bsize2)
...
#ifndef __PGI
    subroutine SEQ_FILE_WRITE_REAL16(fh, buf)
        integer(ip),           intent(in)              :: fh
        real(16),               intent(in)              :: buf
        write(fh) buf
    end subroutine

    subroutine SEQ_FILE_WRITE_REAL16_V(fh, buf, bsize)
        integer(ip),           intent(in)              :: fh
    ...
    subroutine SEQ_FILE_WRITE_REAL16_M(fh, buf, bsize1, bsize2)
        integer(ip),           intent(in)              :: fh
        real(16), pointer,      intent(in)              :: buf(:,:)
        integer(ip),           intent(in)              :: bsize1, bsize2
        write(fh) buf(1:bsize1, 1:bsize2)

...
typedef enum {
	...
	NODE, BAR_2, BAR_3,BAR_4, 				/* 2, 3, 4, 	*/
	TRI_3, TRI_6,					/* 5, 6,	*/
	QUAD_4, QUAD_8, QUAD_9,QUAD_16,				/* 7, 8, 9,	*/
...
/* begin KMW */
int cg_coord_partial_write(int fn, int B, int Z, DataType_t type,
...
/* begin KMW */
int cg_field_partial_write(int fn, int B, int Z, int S, DataType_t type,

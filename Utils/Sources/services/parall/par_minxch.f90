  ...
  if(kfl_paral>0) then
     ...
     if(party==1) then
        ...
        if(pardi==1.and.parki==1) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_SPARR1','par_minxch',loc_sparr1)

           allocate(loc_rparr1(commd%bound_dim),stat=istat)
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_RPARR1','par_minxch',loc_rparr1)
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_RPARR1','par_minxch',loc_rparr1)
           deallocate(loc_rparr1,stat=istat)
           if(istat/=0) call memerr(two,'LOC_RPARR1','par_minxch',0_ip)

           call memchk(two,istat,mem_servi(1:2,servi),'LOC_SPARR1','par_minxch',loc_sparr1)
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_SPARR2','par_minxch',loc_sparr2)

           allocate(loc_rparr2(pard1,commd%bound_dim),stat=istat)
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_RPARR2','par_minxch',loc_rparr2)
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_RPARR2','par_minxch',loc_rparr2)
           deallocate(loc_rparr2,stat=istat)
           if(istat/=0) call memerr(two,'LOC_RPARR2','par_minxch',0_ip)

           call memchk(two,istat,mem_servi(1:2,servi),'LOC_SPARR2','par_minxch',loc_sparr2)

  ...
  if(party==1) then
     ...
     if(pardi==1.and.parki==1) then
        ...
        if(IMASTER) then 
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'PARI1','par_scatte',pari1)
           ipoin=1
           do kfl_desti_par= 1, npart_par
              allocate(loc_pari1(npoin_par(kfl_desti_par)),stat=istat)
              call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARI1','par_scatte',loc_pari1)
              ...
              call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARI1','par_scatte',loc_pari1)
        ...
        if(IMASTER) then 
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'PARR1','par_scatte',parr1)
           ipoin=1
           do kfl_desti_par= 1, npart_par
              allocate(loc_parr1(npoin_par(kfl_desti_par)),stat=istat)
              call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR1','par_scatte',loc_parr1)
              ...
              call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR1','par_scatte',loc_parr1)
        ...
        if(IMASTER) then 
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'PARR2','mod_postpr',parr2)
           ipoin=1
           do kfl_desti_par= 1, npart_par
              allocate(loc_parr2(pard1,npoin_par(kfl_desti_par)),stat=istat)
              call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR2','par_scatte',loc_parr2)
              ...
              call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR2','par_scatte',loc_parr2)
...
!!$              call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR3','par_scatte',loc_parr3)
!!$              call par_receiv()
...
!!$                 end do
!!$              end do
!!$              call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR3','par_scatte',loc_parr3)

...
!  integer(ip), pointer       :: loc_pari1(:)
  ...
  if( IMASTER .and. itask == 1 ) then
     ...
     call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR1','par_gather',loc_parr1)
     nparr = 0
     do ielem = 1,nelem
        do idime = 1,ndime
     ...
     parre => loc_parr1
     call par_sendin()
     call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR1','par_gather',loc_parr1)
  ...
  if( IMASTER .and. itask == 2 ) then
     ...
     !call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARI1','par_gather',loc_pari1)
     ...
     !call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARI1','par_gather',loc_pari1)

subroutine par_mygather()
  ...
  use mod_memchk
  implicit none
  integer(ip)          :: ielem,iboun,ipoin,ibopo,kdime
  integer(ip)          :: jelem,jboun,jpoin,jbopo,idofn
  ...
  if( party == 1 ) then
     ...
     if( pardi == 1 .and. parki == 1 ) then
        ...
        if( IMASTER .and. .not. READ_AND_RUN() ) then   
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARI1','par_mygather',loc_pari1)
           do ielem = 1, nelem
           ...
           enddo
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARI1','par_mygather',loc_pari1)
        ...
        if( IMASTER .and. .not. READ_AND_RUN() ) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARI2','par_mygather',loc_pari2)
           do ielem = 1, nelem
              jelem = leinv_par(ielem)
              do ipar1 = 1,pard1
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARI2','par_mygather',loc_pari2)
        ...
        if( IMASTER .and. .not. READ_AND_RUN() ) then   
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR1','par_mygather',loc_parr1)
           do ielem = 1, nelem
              jelem = leinv_par(ielem)
           ...
           do kfl_desti_par = 1,npart_par
              ...
              ii = ii + nelem_par(kfl_desti_par)
           enddo
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR1','par_mygather',loc_parr1)
        ...
        if( IMASTER .and. .not. READ_AND_RUN() ) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR3','par_mygather',loc_parr3)
           do ielem = 1,nelem
              jelem = leinv_par(ielem)
              do ipar2 = 1,pard2
                 do ipar1 = 1,pard1
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR3','par_mygather',loc_parr3)
     ...
     if( pardi == 1 .and. parki == 1 ) then
        ...
        if( IMASTER .and. .not. READ_AND_RUN() ) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR2','par_mygather',loc_parr2)
           do iboun = 1, nboun
              jboun = lbper_par(iboun)
              do ipar1=1,pard1
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR2','par_mygather',loc_parr2)

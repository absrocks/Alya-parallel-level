  ...
  if(party==3) then
     ...
     if(pardi==1.and.parki==2) then
        ...
        if( ISLAVE ) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'PERFI','par_scafil',perfi)

           allocate(loc_parr1(jfilt),stat=istat)
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR1','par_scafil',loc_parr1)
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR1','par_scafil',loc_parr1)
           deallocate(loc_parr1,stat=istat)
           if(istat/=0) call memerr(two,'LOC_PARR1','par_scafil',0_ip)
           call memchk(two,istat,mem_servi(1:2,servi),'PERFI','par_scafil',perfi)
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'PARR1','par_scafil',parr1)
           allocate(pari1(pfilt),stat=istat)
           call memchk(zero,istat,mem_servi(1:2,servi),'PARI1','par_scafil',pari1)
           ipoin = 1
        ...
        if( ISLAVE ) then
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'LOC_PARR2','par_scafil',loc_parr2)
           ...
           call memchk(two,istat,mem_servi(1:2,servi),'LOC_PARR2','par_scafil',loc_parr2)
           ...
           call memchk(zero,istat,mem_servi(1:2,servi),'PARR2','par_scafil',parr2)
           allocate(pari1(pfilt),stat=istat)
           call memchk(zero,istat,mem_servi(1:2,servi),'PARI1','par_scafil',pari1)
           ipoin = 1

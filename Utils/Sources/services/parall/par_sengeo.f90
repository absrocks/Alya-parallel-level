subroutine par_sengeo(itask)
  ...
  case( 1_ip )
     ...
     if( IMASTER ) then
        ...
        call memory_alloca(mem_servi(1:2,servi),'LMAST_LOC','par_sengeo',lmast_loc,npoin_total)
        ...
        call memory_alloca(mem_servi(1:2,servi),'LEINV_TMP','par_sengeo',leinv_tmp,nelem)
        call memory_alloca(mem_servi(1:2,servi),'LESUB_LOC','par_sengeo',lesub_loc,nelem)
        call memory_alloca(mem_servi(1:2,servi),'LMATE_LOC','par_sengeo',lmate_loc,nelem)
        ...
        call memory_alloca(mem_servi(1:2,servi),'LBINV_TMP','par_sengeo',lbinv_tmp,nboun)
        ...
        call memory_deallo(mem_servi(1:2,servi),'LMATE_LOC','par_sengeo',lmate_loc)
        call memory_deallo(mem_servi(1:2,servi),'LEINV_TMP','par_sengeo',leinv_tmp)
        ...
        call memory_deallo(mem_servi(1:2,servi),'LMAST_LOC','par_sengeo',lmast_loc)
        ...
        call memory_alloca(mem_servi(1:2,servi),'LNINV_LOC','par_sengeo',lninv_loc,npoin) ! PIPI
        call memory_alloca(mem_servi(1:2,servi),'LEINV_LOC','par_sengeo',leinv_loc,nelem) ! PIPI
        call memory_alloca(mem_servi(1:2,servi),'LBINV_LOC','par_sengeo',lbinv_loc,max(1_ip,nboun)) 
        !
        ! Receive LNOCH_LOC
        !
        ...
        ! Receive LMAST_LOC
        !
        call par_srinte(2_ip,npoin,lmast)
        !
        ! Receive LNINV_LOC
        !
        ...
        ! Receive LMATE_LOC
        !
        call par_srinte(2_ip,nelem,lmate) 
        ...
        if( nboun > 0 ) then
           ...
           ! Receive LBINV_LOC
           !
           call par_srinte(2_ip,nboun,lbinv_loc)
        end if
        !
        ! Groups
        !
  ...
  case( 2_ip )
     ...
     if( IMASTER .and. kfl_ptask /= 2 ) then
        ...
        call memory_alloca(mem_servi(1:2,servi),'LELBO_LOC','par_sengeo', lelbo_loc,nboun)
        ...
        call memory_deallo(mem_servi(1:2,servi),'LELBO_LOC' ,'par_sengeo', lelbo_loc)

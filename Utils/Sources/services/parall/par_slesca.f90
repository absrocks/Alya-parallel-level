subroutine par_slesca
...
#endif
  integer(ip)              :: ii,bsize,bsire,dom_i,jj,kk
  integer(4)               :: istat,bsize4,bsire4
  real(rp)                 :: time1,time2
  ...
  if( ISLAVE ) then
     ...
     call memchk(zero,istat,mem_servi(1:2,servi),'LOC_SPARI1','par_slesca',loc_spari1)
     ...
     do ii= 1, nneig
        ...
        call memchk(zero,istat,mem_servi(1:2,servi),'LOC_SPARI1','par_slesca',loc_rpari1)
        ...
        call memchk(two,istat,mem_servi(1:2,servi),'LOC_RPARI1','par_slesca',loc_rpari1)
        deallocate(loc_rpari1,stat=istat)
        if(istat/=0) call memerr(two,'LOC_RPARI1','par_slesca',0_ip)

     end do

     call memchk(two,istat,mem_servi(1:2,servi),'LOC_SPARI1','par_slesca',loc_spari1)

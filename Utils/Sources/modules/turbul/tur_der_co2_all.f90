subroutine tur_der_co2_all(&
  ...
  use def_turbul, only     :  nturb_tur,iunkn_tur,kfl_timei_tur,&
       ...
       &                      ldiss_material_tur, kfl_discd_tur,kfl_clipp_tur
  implicit none
  ...
  integer(ip)              :: idime,inode,iturb,jdime, kdime, auxin
  real(rp)                 :: gpgra,gppro,gpwal,gpgte(3), phi, As,uaste
  real(rp)                 :: gpust,gphev,gppr2,gpsqk,gpgrp(3),gplap, eta, seci4, A0, W, react, grtur(ndime, 2)

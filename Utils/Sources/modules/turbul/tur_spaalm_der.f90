subroutine tur_spaalm_der(&
  ...
  use def_kermod, only     :  cmu_st,kfl_dvar_type
  ...
  integer(ip)              :: iprod,idime,jdime,inode,imeth,kdime,knode
  real(rp)                 :: fv1,fv2,fw,X,g,r,S,Stild,fv3
  real(rp)                 :: cb1,cb2,cv1,sigma,cw1,cw2,cw3,vonka
  real(rp)                 :: siinv,ft2,ct3,ct4
  real(rp)                 :: k2,d2,Xto3,k2d2,Xocv2,gto6
  real(rp)                 :: ono6,cw3t6,cv2,cv3,fact1

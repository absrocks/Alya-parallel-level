...
subroutine sld_stress_model_137(&
  ...
  use def_solidz
  use def_master, only       :  &
       cutim,ittim,postp,ittyp,ITASK_ENDRUN,fiber,gpfib,vconc,coupling,kfl_paral,fisoc
  ...
  real(rp)                   :: elfib(3,mnode),elfib_2(3,mnode),elfis(3,mnode),elfin(3,mnode)
  ...
  real(rp)                   :: term5,term6,term7,term11,term22,term33,term44,term55,term66,term77, &
                                inter1,traceb_bar,trace_fporf,trace_fporf_2

subroutine sld_angle2(imate,kangl)
  ...
  real(rp)                   :: xcord,ycord,zcord,vuni1(3),uuni1(3),vuni2(3),bidon,nfibe0(ndime)
  
  real(rp)                   :: lenght_pnt,angle1,omega,a_epi,b_epi,yp_epi,zp_epi,lenght_end,l_star,&
       rotma(3,3),nfibe0T(ndime),lenght_epi,yp_end,zp_end,a_end,b_end,nore1,rcord,&
       b_qua,d_qua,c_end,a_hyp,nu,mu_end,mu_epi,mu,helix,x_endo,y_endo,z_endo,phi   
  
  integer(ip)                :: idime,jdime,kdime,pelty,inode,ipoin,kpoin

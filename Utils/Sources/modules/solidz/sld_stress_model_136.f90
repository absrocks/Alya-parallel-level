...
subroutine sld_stress_model_136(&
  ...
  use def_solidz
  use def_master, only       :  &
       cutim,ittim,postp,ittyp,ITASK_ENDRUN,fiber,gpfib,vconc,coupling,kfl_paral
  ...
  real(rp)                   :: i1,i4f,i4s,i4n,i8fs,i8sf,i4ff,i4sf,i8sn,i8ns,i8nf,i8fn 
  real(rp)                   :: fporf(ndime,ndime),fporf_t(ndime,ndime),spors(ndime,ndime),nporn(ndime,ndime)
  real(rp)                   :: fpors(ndime,ndime),sporf(ndime,ndime),fporn(ndime,ndime),nporf(ndime,ndime),sporn(ndime,ndime),npors(ndime,ndime)
  real(rp)                   :: term1,term2,term3,term4,term5,term6,termK
  ...
  real(rp)                   :: rotma(3,3),lenght_epi,yp_end,zp_end,a_end,b_end,nore1

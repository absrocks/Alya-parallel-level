...
!!! First calculate the auxiliaries, Currents, then concentrations and then calculate new voltage,      
     ...
     if (kfl_cellmod(nodemat(ipoin)) == 4) then
        ...
        vaux3 = (vicel_exm(12,ipoin,2) + vicel_exm(9,ipoin,2)) - (2.0_rp *  vicel_exm(7,ipoin,2) )
        vaux3 = vaux1 * vaux3 * capacit
        vaux2 = (vicel_exm(13,ipoin,2) - vicel_exm(14,ipoin,2)) * (volsr / volcyto) + vicel_exm(18,ipoin,2)
        ...
        vaux1 = vicel_exm(14,ipoin,2) - vicel_exm(13,ipoin,2) - vicel_exm(15,ipoin,2)
        ...
        vaux1 = vaux1 * vicel_exm(2,ipoin,2) * capacit
        vaux2 = vicel_exm(15,ipoin,2) * volsr / volss
        vaux3 = vicel_exm(18,ipoin,2) * volcyto / volss
        ...
        vaux3 = (3.0_rp * vicel_exm(8,ipoin,2)) + (3.0_rp * vicel_exm(7,ipoin,1)) 
        vaux3 = vaux3 + vicel_exm(1,ipoin,2) + vicel_exm(11,ipoin,2)
        ...
        vaux3 = (vicel_exm(6,ipoin,2) + vicel_exm(3,ipoin,2) + vicel_exm(5,ipoin,2) &
             + vicel_exm(4,ipoin,2) + vicel_exm(10,ipoin,2) + vicel_exm(16,ipoin,2)) - (2.0_rp * vicel_exm(8,ipoin,2)) 
        ...
        if (elmag(ipoin,ITER_K) >= -40.0) then

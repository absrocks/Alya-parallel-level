...
!  integer(ip),  pointer ::&
  ...
  integer(ip) ::         &
       ...
       modce_exm,      &         ! Cell type
       modac_exm,      &         ! Activation potential field
  ...
  real(rp) ::&
       ...
       gfibe_exm(3),&               ! Global fiber orientation
       xmopa_exm(20,kfl_exm_max_nmaterials),&           ! Physical model parameters
       ttparmate_exm(3,12,kfl_exm_max_nmaterials),&     ! parameters to identify normal vs heart failure 1-cell simulations
       drugdmate_exm(12,kfl_exm_max_nmaterials),&       ! parameters to introduce a drug effect on cell models
       vminimate_exm(3,kfl_exm_max_nmaterials), &       ! new voltage(celltype,imate)
       ...
       vauin_exm(30,3,kfl_exm_max_nmaterials),&          ! initial values of  vauxi for 3D simulation 
       vcoin_exm(12,3,kfl_exm_max_nmaterials),&          ! initial vaules of vconc for 3D simulation
       ...
       volelec_exm,&                ! Volume integral of electrical activation
       ...
       fract_diff_exm(kfl_exm_max_nmaterials)           ! Fractional diffusion coefficient S
...
!
  ...
  logical,  allocatable :: isoch_modified(:) ! TRUE when isochrone was detected. Used as a trigger to save isochrones

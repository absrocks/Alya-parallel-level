...
subroutine exm_ohaland_calcium(kmcmdn,kmtrpn,cmdnmax,trpnmax,vnsr,vmyo,vss,acap,farad,dtimeEP,ipoin,cai,sac,volt)
  ...
  real(rp), intent(in) :: kmcmdn,kmtrpn,cmdnmax,trpnmax,vnsr,vmyo,vss,acap,farad,dtimeEP,volt
  ...
  dCaTRPN = troponin(ipoin)-troponin_prev(ipoin)
  ...
  ! Update troponin
  troponin_prev(ipoin) = troponin(ipoin)

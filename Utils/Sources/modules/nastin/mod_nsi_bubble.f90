...
!!$    integer(ip) :: inode,igaus,jnode,idime
!!$       !
!!$       ! OJO BORRAR =>
!!$       !
!!$       igaus = 0
...
!!$             igaus = igaus + 1
!!$             elauu(1:VECTOR_SIZE,inode,jnode) = real(igaus,rp)
!!$          end do
!!$          do jnode = 1,pnode
!!$             igaus = igaus + 1
!!$             elaup(1:VECTOR_SIZE,inode,jnode) = real(igaus,rp)
!!$          end do
!!$          igaus = igaus + 1
!!$          elauq(1:VECTOR_SIZE,inode,1) = real(igaus,rp)
!!$       end do
!!$       do inode = 1,pnode
!!$          do jnode = 1,pnode*ndime
!!$             igaus = igaus + 1
!!$             elapu(1:VECTOR_SIZE,inode,jnode) = real(igaus,rp)
!!$          end do
!!$          do jnode = 1,pnode
!!$             igaus = igaus + 1
!!$             elapp(1:VECTOR_SIZE,inode,jnode) = real(igaus,rp)
!!$          end do
!!$          igaus = igaus + 1
!!$          elapq(1:VECTOR_SIZE,inode,1) = real(igaus,rp)
!!$       end do
!!$       inode = 1
!!$       do jnode = 1,pnode*ndime
!!$          igaus = igaus + 1
!!$          elaqu(1:VECTOR_SIZE,inode,jnode) = real(igaus,rp)
!!$       end do
!!$       do jnode = 1,pnode
!!$          igaus = igaus + 1
!!$          elaqp(1:VECTOR_SIZE,inode,jnode) = real(igaus,rp)
!!$       end do
!!$       igaus = igaus + 1
!!$       elaqq(1:VECTOR_SIZE,inode,1) = real(igaus,rp)
!!$       igaus = 0
!!$       do inode = 1,pnode
!!$          do idime = 1,ndime
!!$             igaus = igaus + 1
!!$             elrbu(1:VECTOR_SIZE,idime,inode) = real(igaus,rp)
!!$          end do
!!$       end do
!!$       do inode = 1,pnode
!!$          igaus = igaus + 1
!!$          elrbp(1:VECTOR_SIZE,inode) = real(igaus,rp)
!!$       end do
!!$       igaus = igaus + 1
!!$       elrbq(1:VECTOR_SIZE,1) = real(igaus,rp)

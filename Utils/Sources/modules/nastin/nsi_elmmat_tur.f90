subroutine nsi_elmmat_tur(                                &
  ...
  use def_nastin, only       :  kfl_cotur_nsi,kfl_stabi_nsi,nbdfp_nsi,dtinv_nsi
  ...
  use def_nastin, only       :  kfl_p1ve2_nsi,vepro_nsi,kfl_linea_nsi,ncomp_nsi,kfl_fixno_nsi
  ...
  integer(ip)                :: jdime, itime, ind,iturb

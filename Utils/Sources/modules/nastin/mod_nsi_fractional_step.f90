...
module mod_nsi_fractional_step
  ...
  real(rp),   pointer :: Nu(:)      ! Nodal projection of mu/rho
...
contains
  ...
  subroutine nsi_fractional_step_allocate()
    ...
    if( ipass == 0 ) then
       ...
       if( INOTMASTER ) then
          ...
          call memory_alloca(mem_modul(1:2,modul),'VV'    ,'mod_nsi_fractional_step',vv    ,ndime*npoin)
          call memory_alloca(mem_modul(1:2,modul),'RM'    ,'mod_nsi_fractional_step',rm    ,ndime*npoin,4_ip) ! A discutir
          call memory_alloca(mem_modul(1:2,modul),'RT'    ,'mod_nsi_fractional_step',rt    ,ndime*npoin)
          call memory_alloca(mem_modul(1:2,modul),'RC'    ,'mod_nsi_fractional_step',rc    ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'DIVUP' ,'mod_nsi_fractional_step',divup ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'BP2'   ,'mod_nsi_fractional_step',bp2   ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'BP1'   ,'mod_nsi_fractional_step',bp1   ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'DP'    ,'mod_nsi_fractional_step',Dp    ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'DPP'   ,'mod_nsi_fractional_step',Dpp   ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'AUPP'  ,'mod_nsi_fractional_step',Aupp  ,ndime*npoin)
          call memory_alloca(mem_modul(1:2,modul),'TIM'   ,'mod_nsi_fractional_step',Tim   ,npoin,3_ip)
          call memory_alloca(mem_modul(1:2,modul),'NU'    ,'mod_nsi_fractional_step',Nu    ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'TAU'   ,'mod_nsi_fractional_step',Tau   ,npoin)
          call memory_alloca(mem_modul(1:2,modul),'RT_TMP','mod_nsi_fractional_step',rt_tmp,ndime*npoin)
                 
       else

          call memory_alloca(mem_modul(1:2,modul),'VV'    ,'mod_nsi_fractional_step',vv    ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'RM'    ,'mod_nsi_fractional_step',rm    ,1_ip,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'RT'    ,'mod_nsi_fractional_step',rt    ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'RC'    ,'mod_nsi_fractional_step',rc    ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'DIVUP' ,'mod_nsi_fractional_step',divup ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'BP2'   ,'mod_nsi_fractional_step',bp2   ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'BP1'   ,'mod_nsi_fractional_step',bp1   ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'DP'    ,'mod_nsi_fractional_step',Dp    ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'DPP'   ,'mod_nsi_fractional_step',Dpp   ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'AUPP'  ,'mod_nsi_fractional_step',Aupp  ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'TIM'   ,'mod_nsi_fractional_step',Tim   ,1_ip,3_ip)
          call memory_alloca(mem_modul(1:2,modul),'NU'    ,'mod_nsi_fractional_step',Nu    ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'TAU'   ,'mod_nsi_fractional_step',Tau   ,1_ip)
          call memory_alloca(mem_modul(1:2,modul),'RT_TMP','mod_nsi_fractional_step',rt_tmp,1_ip)
  ...
  end subroutine nsi_fractional_step_allocate
  ...
  subroutine nsi_fractional_step_solution()
    ...
    call nsi_fractional_step_allocate()
  ...
  subroutine nsi_fractional_step_solution_tau()
    ...
    integer(ip)         :: ipoin,idime,ii
    integer(ip)         :: maxit,itera
    real(rp)            :: toler,resid
    real(rp),   pointer :: AupDp(:,:)  ! Aup Dp
    real(rp),   pointer :: Dpp2(:)     ! Dp^{n+1,k}
    real(rp),   pointer :: pp2(:)      ! p^n
    real(rp)            :: pnorm
...
1   continue
  ...
  subroutine nsi_fractional_step_continuity_tau_cg()
    ...
    integer(ip)         :: ipoin,idime,ii,iz,jj,jz
    integer(ip)         :: maxit,itera
    real(rp)            :: toler,resid
    real(rp)            :: numer,denom,invnb
    real(rp)            :: rho,newrho
    real(rp),   pointer :: bb(:)            ! RHS
    real(rp),   pointer :: xx(:)            ! Solution
    real(rp),   pointer :: zz(:)            !

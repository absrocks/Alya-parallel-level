...
subroutine nsi_elmope_all(itask)
  ...
  use mod_nsi_element_operations_fast, only : nsi_element_operations_fast5
  use mod_nsi_element_operations_fast, only : nsi_element_operations_fast8
  use def_master,                      only : veloc,rhsid
  use def_nastin,                      only : dt_rho_nsi,mu_rho_nsi
...
#ifdef EXTRAE_ASSEMBLY
  call extrae_restart()
  call extrae_eventandcounters(789456_4,1_8)
#endif
     ...
     !$acc enter data create(dt_rho_nsi,mu_rho_nsi,rhsid,veloc)

     !$acc update device(dt_rho_nsi,mu_rho_nsi,rhsid,veloc)

#ifndef OPENACCHHH
#endif

#ifdef EXTRAE_ASSEMBLY
  call extrae_eventandcounters(789456_4,0_8)
#endif

#ifdef EXTRAE_ASSEMBLY
  call extrae_eventandcounters(789456_4,2_8)
#endif
...
#ifdef EXTRAE_ASSEMBLY
  call extrae_eventandcounters(789456_4,3_8)
#endif

      !$acc update host(rhsid,dt_rho_nsi,mu_rho_nsi)

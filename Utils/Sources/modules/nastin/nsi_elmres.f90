...
subroutine nsi_elmres(                                              &
  ...
  use def_kermod, only     :  thicl,gasco,kfl_prope,densi_ker,kfl_adj_prob
  ...
  use def_nastin, only     :  kfl_cotur_nsi,grnor_nsi,gravi_nsi,     &
       ...
       &                      kfl_sgsli_nsi,kfl_penal_nsi,penal_nsi, &
       &                      kfl_bubbl_nsi
  use def_master, only     :  prthe,dpthe

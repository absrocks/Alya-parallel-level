subroutine got_elmop3()
  ...
  elements: do ielem=1,nelem
     ...
     call got_elmpre(&
          ...
          elcdr_got,elvdr_got,dummr,gpcdr,gpcod,&
          gpvdr,gpvel,gpgvd,dummr,gpdiv,dummr,gpvno)
     !
     ! Residual: RESIC
     !
     call got_elmre3(&
          pnode,pgaus,elmar(pelty)%shape,gpcar,gpvdr,gpdiv,resic) 
     !
     ...
     !
     call got_elmte3(&
          pnode,pgaus,elmar(pelty)%shape,gpcar,gpvdr,gpdiv,gpst2,tescb) 
     !

subroutine ale_smooth()
  ...
  integer(ip)           :: izdom,jpoin,kfl_recov
  ...
  if( kfl_smoot_ale == 1 ) then
     ...
     do iters = 1,nsmoo_ale
        ...
        do ielem = 1,nelem
           ...
           if( pelty > 0 ) then
              ...
              do inode = 1,pnode
                 ...
                 eless(1:ndime,inode)     = bvess_ale(1:ndime,ipoin)
              end do
              call elmlen(&
        ...
        if( INOTMASTER ) & 
             call ale_smooth_fixity(ndime,kfl_fixno_ale,bvess_ale,amatr,rhsid,unkno)

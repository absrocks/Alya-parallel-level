subroutine ale_output()
  ...
  implicit none
  integer(ip) :: ivari,ivarp,iimbo,iiset,inaux
        ...
        if ( kfl_rigid_ale == 1 ) then
           ...
           do iimbo = 1,nrbod
              ...
              do iiset = 1,rbbou(iimbo) % nrbse
                 write(lun_outpu_ale,101) rbbou(iimbo) % lrbse(iiset),&
                      posil(1,1),posil(2,1),posil(3,1),velol(1,1),velol(2,1),velol(3,1),accel(1,1),accel(2,1),accel(3,1),   &
                      posia(1,1),posia(2,1),posia(3,1),veloa(1,1),veloa(2,1),veloa(3,1),accea(1,1),accea(2,1),accea(3,1),   &

subroutine tem_elmope_new(order)
  ...
  elements: do ielem = 1,nelem
     ...
     if( pelty > 0 ) then
        ...
        !
        call tem_elmgat(&
             ielem,pnode,lnods(1,ielem),eltem,elvel,elcod,eledd,elDik,elmsh)
        !
        ...
        !
        call tem_turbul(&
             ielem,pnode,pgaus,1_ip,pgaus,gpsha,gpcon,gpsph,gpdif,gpgrd,gpden,gptur)
        ...
        !
        call tem_elmpre(&  
             ielem,pnode,pgaus,pmate,gpden,gpsph,gpsgv,gpsha,gpcar,gphes,elvel,eltem,&
             elcod,elmsh,gpvel,gptem,gprhs,gpcod,gpgrt,lnods(1,ielem),gpmsh)
        !

...
subroutine tem_gradient_gauss (xvalu,xgrad)
  ...
  integer(ip)           :: iiz,ijz,jiz,iboun
  real(rp)              :: Area,value_dirichlet,value_neumann
  real(rp)              :: Vol, invVol_i, invVol_j,avtem,xfact(ndime)
...
subroutine tem_gradient_ls (xvalu,xgrad)
  ...
  integer(ip)           :: iiz,ijz,jjz,jiz,iboun
  real(rp)              :: value_dirichlet,value_neumann

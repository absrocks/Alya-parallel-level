...
subroutine pts_inibcs()
  ...
  if( INOTMASTER ) then
     ...
     call memory_alloca(mem_modul(1:2,modul),'KFL_FIXBO_PTS','pts_inibcs',kfl_fixbo_pts,nboun_2)
     call memory_alloca(mem_modul(1:2,modul),'BVNAT_PTS'    ,'pts_inibcs',bvnat_pts,1_ip,nboun_2)

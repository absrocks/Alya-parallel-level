program alya_deposition
  ...
  real(8)               :: xcoord,ycoord,zcoord,time,r,per,de1
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     do i=1,max_part_type
      ...
      write(6,*) '--|'
     write(6,*) '--| number of deposited particle in the olfactory clift         = ',depo1
     write(6,*) '--| total number of particle deposited                          = ',numdepo
     write(6,*) '--|'

     write(6,*) '--|  olfactory clift Deposition efficiency= ',(real(depo1)/real(numdepo))*100,'%'
     de1=real(depo1)/real(numdepo)*100
     write(6,*) '--|'
     write(6,*) '--|'
     write(6,*) '--|'
     end do

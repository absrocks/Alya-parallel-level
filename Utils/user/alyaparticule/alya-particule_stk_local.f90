program alya_particule
  ...
  real(8)               :: xcoord,ycoord,zcoord,xvelo,yvelo,zvelo,time,ax,ay,az,cd,re,r,stk_inst,stk_eff
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  write(12,*)'time,part_id,xcoord,ycoord,zcoord,modvel,modacc,part_type,subdom,Cd,Stk_inst,Stk_eff'
  read(10,*)
  read(10,*)
  read(10,*)
  read(10,*)
  ...
  read(10,*)
  do ii =1,nline
     read (10,*) time,part_id,xcoord,ycoord,zcoord,xvelo,yvelo,zvelo,part_type,subdom,ax,ay,az,cd,stk_inst,stk_eff
     ...
     if (mod(part_id,modu)==0) write(12,84) time,part_id,xcoord,ycoord,zcoord,modvel,modacc,part_type,subdom,cd,stk_inst,stk_eff
  end do
  close (10)
  close (12)
...
84 format (e12.6,',',i8,5(',',e12.6)',',i2,',',i6,3(',',e12.6))

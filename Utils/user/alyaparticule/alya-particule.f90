...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  read(10,*)
  do ii =1,nline
     read (10,*) time,part_id,part_type,exist,xcoord,ycoord,zcoord,xvelo,yvelo,zvelo,dt,cd
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  open(unit=10,file=fil_name,status='old')
  write(12,*)'time,part_id,part_type,exist,xcoord,ycoord,zcoord,modvel,dt,cd'
  read(10,*)
  read(10,*)
  read(10,*)
  read(10,*)
  ...
  do ii =1,nline
     ...
     if (mod(part_id,modu)==0) write(12,84) time,part_id,part_type,exist,xcoord,ycoord,zcoord,modvel,dt,cd
  end do
  close (10)
  close (12)
...
84 format (e12.6,3(',',i8),6(',',e12.6))!time,part_id,part_type,exist,xcoord,ycoord,zcoord,modvel,dt,cd

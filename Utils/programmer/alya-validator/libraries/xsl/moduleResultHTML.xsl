        ...
        <div id="wrapper">
          <div id="wrapper2">            
            ...
            <div class="nosidebar" id="main">
              ...
              <div id="content">
                <h2><xsl:value-of select="name"/> Module</h2>                
                <div class="tabs">
                  <ul>
                    <li>Information</li>      
                  </ul>  
                  ...
                  <table class="list versions" border="1px">
                    ...
                    <tbody>                      
                      <tr class="version odd open ">
                        <td class="name" align="center">A rellenar!!</td>
                        <td class="description" align="center">A rellenar!!</td>
                        <td align="center">A rellenar!!</td>
                  ...
                  <table class="list versions" border="1px">
                    ...
                    <tbody>
                      <xsl:for-each select="testResults/testResult">
                        <tr class="version odd open ">
                          <td class="name" align="center"><xsl:value-of select="testName"/></td>
                          ...
                          <td class="buttons" align="center">
                            <xsl:if test="passed = 'false'"><a class="icon icon-edit">
                              <xsl:attribute name="href">
                                <xsl:value-of select="testName" />/<xsl:value-of select="testName" />.html
                              </xsl:attribute>
                              Open</a></xsl:if>                                  
                          </td>
                        </tr>

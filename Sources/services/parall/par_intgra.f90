subroutine par_intgra(kpoin,permR,ia)
  ...
  ! 
  call memory_alloca(mem_servi(1:2,servi),'NEPOI_TMP','par_intgra',nepoi_tmp,npoin)
  ...
  !
  call memory_alloca(mem_servi(1:2,servi),'PELPO_TMP','par_intgra',pelpo_tmp,npoin+1_ip)
  pelpo_tmp(1) = 1
  do ipoin = 1,npoin
  ...
  !
  call memory_alloca(mem_servi(1:2,servi),'LELPO_TMP','par_intgra',lelpo_tmp,pelpo_tmp(npoin+1))
  mpopo_tmp = 0
  do ielem = 1,nelem
  ...
  !
  call memory_deallo(mem_servi(1:2,servi),'NEPOI_TMP','par_intgra',nepoi_tmp)
  ...
  call memory_alloca(mem_servi(1:2,servi),'LISTA','par_intgra',lista,mpopo_tmp)
  !
  ...
  ! Deallocate memory
  !
  call memory_deallo(mem_servi(1:2,servi),'LISTA'    ,'par_intgra',lista)
  call memory_deallo(mem_servi(1:2,servi),'PELPO_TMP','par_intgra',pelpo_tmp)
  call memory_deallo(mem_servi(1:2,servi),'LELPO_TMP','par_intgra',lelpo_tmp)

...
subroutine par_domgra(inter,front,memor)
  ...
  ! 
  call memory_alloca(mem_servi(1:2,servi),'NEIGHDOM','par_domgra' , neighDom , (npart_par*(npart_par+1))/2 )
  ...
  call memory_alloca(mem_servi(1:2,servi),'DOMLI','par_domgra' , domli , mepoi )
  ...
  call memory_deallo(mem_servi(1:2,servi),'DOMLI','par_domgra' , domli )
  !

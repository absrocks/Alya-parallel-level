subroutine par_cregrp(itask)
  ...
  case(1_ip)
     ...
     call memchk(zero,istat,mem_servi(1:2,servi),'LOC_SPARI1','par_cregrp',loc_spari1)

     allocate(loc_rpari1(commd%bound_dim),stat=istat)
     call memchk(zero,istat,mem_servi(1:2,servi),'LOC_RPARI1','par_cregrp',loc_rpari1)
     ...
     call memchk(two,istat,mem_servi(1:2,servi),'LOC_RPARI1','par_cregrp',loc_rpari1)
     deallocate(loc_rpari1,stat=istat)
     if(istat/=0) call memerr(two,'LOC_RPARI1','par_cregrp',0_ip)

     call memchk(two,istat,mem_servi(1:2,servi),'LOC_SPARI1','par_cregrp',loc_spari1)
  ...
  case(2_ip)
     ...
     call memchk(zero,istat,mem_servi(1:2,servi),'LESSL','par_cregrp',lessl)
  ...
  case(3_ip)
     ...
     call memchk(zero,istat,mem_servi(1:2,servi),'LOC_SPARR1','par_cregrp',loc_sparr1)
     
     allocate(loc_rparr1(ngrou),stat=istat)
     call memchk(zero,istat,mem_servi(1:2,servi),'LOC_RPARR1','par_cregrp',loc_rparr1)
     ...
     call memchk(two,istat,mem_servi(1:2,servi),'LOC_RPARR1','par_cregrp',loc_rparr1)
     deallocate(loc_rparr1,stat=istat)
     if(istat/=0) call memerr(two,'LOC_RPARR1','par_cregrp',0_ip)
     
     call memchk(two,istat,mem_servi(1:2,servi),'LOC_SPARR1','par_cregrp',loc_sparr1)

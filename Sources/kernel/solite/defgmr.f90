subroutine defgmr( &
  ...
  use def_master, only     :  kfl_paral,party,pardi,parki,pard1,parr1,&
       &                      nparr,parre,npoi1,npoi2,npoi3,intost,&
       &                      kfl_ptask,npari,nparc,INOTMASTER
  ...
  integer(ip)              :: ii, jj, kk, ll, jj1, idx, nrows, npopo,ngrou,nskyl,info,ibvar,iplace,ideg

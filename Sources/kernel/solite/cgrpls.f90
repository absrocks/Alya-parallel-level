...
subroutine cgrpls( &
  ...
  use def_master, only       :  IPARALL,kfl_async,parre,ISLAVE
  use def_master, only       :  INOTSLAVE,funin,NPOIN_TYPE
  ...
  use def_domain, only       :  npoin,npoin_own,npoin_halo ! CHANGE
  ...
  integer(ip)                :: ii, nrows, ierr, kcoup, ncols, kk
  integer(4)                 :: istat

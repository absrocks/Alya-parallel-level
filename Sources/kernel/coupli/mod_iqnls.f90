  module mod_iqnls
    ...
    subroutine QRfiltering(currV, histV, currW, histW, current_tracking, history_tracking, epsi, densefiltV, densefiltW )
        ...
        integer(ip)                              :: idof, irank, ihist, iaux, iaux2, iaux3, counter1, counter2, counter3, rindex
       ...
       call PAR_MAX(par_maxndof,'IN CURRENT TARGET COLOR','EXCLUDE MASTER',par_leader_rank)
       IAMHEAD=.false.

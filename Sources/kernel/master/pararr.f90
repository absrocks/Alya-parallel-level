        ...
        if( INOTMASTER ) then
           ...
           if( ntype == NPOIN_TYPE .and. ncoup_implicit > 0 .and. INOTEMPTY ) then
              ...
              do kcoup = 1,ncoup_implicit_n
                 ...
                 if( wtask == 'SOL' ) then
                    call COU_INTERPOLATE_NODAL_VALUES_go(icoup,kk,rvarr_int,rvarr_tmp,solve_sol(1) % kfl_fixno)
                 else
              ...
              do kcoup = 1,ncoup_implicit_d
                 ...
                 if( wtask == 'SOL' ) then
                    call COU_INTERPOLATE_NODAL_VALUES_go(icoup,kk,rvarr,rvarr_tmp,solve_sol(1) % kfl_fixno)
                 else

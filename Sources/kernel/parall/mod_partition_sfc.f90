...
contains
  ...
  subroutine partition_sfc_results(&
    ...
    call PAR_SUM(weights,  PAR_COMM_IN4=COMM4)
    call PAR_MAX(time_comm,PAR_COMM_IN4=COMM4)
    call PAR_MAX(memor_max,PAR_COMM_IN4=COMM4)
  ...
  subroutine partition_sfc_redistribute_weights()
    ...
    !
    call cputim(time1)
    call PAR_ALLTOALL(lnsend_loc,lnrecv_loc,PAR_COMM_IN4=PAR_COMM)
    call cputim(time2)

...
module mod_par_color_communicators
  ...
  use def_master,         only : ISEQUEN,kfl_paral
...
contains
  ...
  subroutine par_color_communicators_allocate()
    ...
    call memory_alloca(par_memor,'PAR_COMM_COLOR',             'par_color_communicators',PAR_COMM_COLOR,     m1,m1,          'INITIALIZE',0_ip,0_ip)
  ...
  subroutine par_color_communicators_deallocate()
    ...
    call PAR_DEALLOCATE_COMMUNICATION_ARRAY(PAR_COMM_COLOR_ARRAY,COMM_NAME='PAR_COMM_COLOR_ARRAY')

...
module mod_parall
  ...
  use mod_communication_arrays, only : PAR_DEALLOCATE_COMMUNICATION_ARRAY
  use mod_communication_arrays, only : PAR_ALLOCATE_COMMUNICATION_ARRAY
  use mod_communication_arrays, only : PAR_COPY_COMMUNICATION_ARRAY
  use mod_communication_arrays, only : PAR_SUB_COMMUNICATION_ARRAY
  use mod_communication_arrays, only : PAR_POINT_COMMUNICATION_ARRAY

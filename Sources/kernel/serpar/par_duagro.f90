...
!-------------------------------------------------------------------------------
  ...
  call memchk(zero,istat,par_memor,'comle(icoml)%translDual','par_metis',comle(icoml)%translDual)
  !
  ...
  call memchk(zero,istat,par_memor,'iwa','par_metis',iwa)
  ...
  call memchk(zero,istat,par_memor,'comle(icoml)%iaDual','par_metis',comle(icoml)%iaDual)
  ...
  call memchk(zero,istat,par_memor,'comle(icoml)%jaDual','par_metis',comle(icoml)%jaDual)
  ...
  call memchk(two,istat,par_memor,'iwa','par_duagro',iwa)

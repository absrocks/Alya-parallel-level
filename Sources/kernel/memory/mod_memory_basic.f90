...
module mod_memory_basic
  ...
  use def_kintyp_basic, only : ip,rp,lg,i1p,i2p,i3p,r1p,r2p,r3p,r4p,i1pp,spmat
  ...
  interface memory_alloca
     ...
     module procedure &
          ...
          &           memory_alloca_r41_8  ,                                                                      & !
          &           memory_alloca_r161   , memory_alloca_r162    , memory_alloca_r163   , memory_alloca_r164 ,  & ! 
          &           memory_alloca_r161_8 ,                                                                      & ! 
          &           memory_alloca_i41    , memory_alloca_i42     , memory_alloca_i43    ,                       & ! INTEGER(4)
          &           memory_alloca_i418   ,                                                                      & ! 
          &           memory_alloca_i81    , memory_alloca_i82     , memory_alloca_i83    ,                       & ! INTEGER(8)
          ...
          &           memory_alloca_spmat  , memory_alloca_spmat_1                                                  ! SPMAT
  ...
  interface memory_deallo
     ...
     module procedure &
          ...
          &           memory_deallo_r161   , memory_deallo_r162    , memory_deallo_r163   , memory_deallo_r164  , & !
          ...
          &           memory_deallo_spmat  , memory_deallo_spmat_1                                                  ! SPMAT
...
contains
  ...
  subroutine memory_alloca_r81(memor,vanam,vacal,varia,ndim1,wzero)
    !
    ! Real(rp)(:)
    !
    implicit none
  ...
  subroutine memory_alloca_r81_8(memor,vanam,vacal,varia,ndim1,wzero)
    !
    ! Real(rp)(:)
    !
    character(*), intent(in)              :: vanam         !< Variable name
  ...
  subroutine memory_alloca_r41(memor,vanam,vacal,varia,ndim1,wzero)
    !
    ! Real(rp)(:)
    !
  ...
  subroutine memory_alloca_r161(dummy)
    
    type(pgi_dummy1), intent(in)          :: dummy
  end subroutine memory_alloca_r161

  subroutine memory_alloca_r161_8(dummy)
    
    type(pgi_dummy2), intent(in)          :: dummy
  end subroutine memory_alloca_r161_8

  subroutine memory_alloca_r162(dummy)
    
    type(pgi_dummy3), intent(in)          :: dummy
  end subroutine memory_alloca_r162

  subroutine memory_alloca_r163(dummy)
    
    type(pgi_dummy4), intent(in)          :: dummy
  end subroutine memory_alloca_r163

  subroutine memory_alloca_r164(dummy)
    
    type(pgi_dummy5), intent(in)          :: dummy
  end subroutine memory_alloca_r164

#else

  subroutine memory_alloca_r161(memor,vanam,vacal,varia,ndim1,wzero)
    !
    ! Real(rp)(:)
    !
  ...
  subroutine memory_alloca_r161_8(memor,vanam,vacal,varia,ndim1,wzero)
    !
    ! Real(rp)(:)
    !
  ...
  subroutine memory_alloca_r162(memor,vanam,vacal,varia,ndim1,ndim2,wzero,lboun1,lboun2)
    !
    ! Real(rp)(:,:)
    !
  ...
  subroutine memory_alloca_r163(memor,vanam,vacal,varia,ndim1,ndim2,ndim3,wzero,lboun1,lboun2,lboun3)
    !
    ! Real(rp)(:,:,:)
    !
  ...
  subroutine memory_alloca_r164(memor,vanam,vacal,varia,ndim1,ndim2,ndim3,ndim4,wzero,lboun1,lboun2,lboun3,lboun4)
    !
    ! Real(rp)(:,:,:,:)
    !
  ...
  subroutine memory_alloca_i41(memor,vanam,vacal,varia,ndim1,wzero,lboun,REALLOCATE)
    !
    ! Integer(4)(:)
    !
  ...
  subroutine memory_alloca_i418(memor,vanam,vacal,varia,ndim1,wzero)
    !
  ...
  subroutine memory_alloca_i42(memor,vanam,vacal,varia,ndim1,ndim2,wzero,lboun1,lboun2)
    !
    ! Integer(4)(:,:)
    !
  ...
  subroutine memory_alloca_r1p_1(memor,vanam,vacal,varia,ndim1,wzero,lboun1)
    !
    ! Type(r1p)(:)
    !
  ...
  subroutine memory_alloca_r2p_1(memor,vanam,vacal,varia,ndim1,wzero,lboun1)
    !
    ! Type(r2p)(:)
    !
  ...
  subroutine memory_alloca_r3p_1(memor,vanam,vacal,varia,ndim1,wzero)
    !
    ! Type(r3p)(:)
    !
  ...
  subroutine memory_alloca_spmat_1(memor,vanam,vacal,varia,ndim1,wzero)
     !
     ! Type(spmat)
     !
  ...
  subroutine memory_alloca_spmat(memor,vanam,vacal,varia,ndof,ndim1,wzero)
     !
     ! Type(spmat)
     !
  ...
  subroutine memory_deallo_r161(dummy)
    
    type(pgi_dummy1), intent(in)          :: dummy
  end subroutine memory_deallo_r161

  subroutine memory_deallo_r162(dummy)
    
    type(pgi_dummy2), intent(in)          :: dummy
  end subroutine memory_deallo_r162

  subroutine memory_deallo_r163(dummy)
    
    type(pgi_dummy3), intent(in)          :: dummy
  end subroutine memory_deallo_r163

  subroutine memory_deallo_r164(dummy)
    
    type(pgi_dummy4), intent(in)          :: dummy
  end subroutine memory_deallo_r164

#else

  subroutine memory_deallo_r161(memor,vanam,vacal,varia)
    !
    ! Real(rp)(:)
    !
  ...
  subroutine memory_deallo_r162(memor,vanam,vacal,varia)
    !
    ! Real(rp)(:,:)
    !
  ...
  subroutine memory_deallo_r163(memor,vanam,vacal,varia)
    !
    ! Real(rp)(:,:,:)
    !
  ...
  subroutine memory_deallo_r164(memor,vanam,vacal,varia)
    !
    ! Real(rp)(:,:,:,:)
    !
  ...
  subroutine memory_deallo_r3p_3(memor,vanam,vacal,varia)
    !
    ! Type(r3p)(:,:,:)
    !
    ...
    if( associated(varia) ) then
       ...
       do idim3 = lbound(varia,3),ubound(varia,3)
          do idim2 = lbound(varia,2),ubound(varia,2)
             do idim1 = lbound(varia,1),ubound(varia,1)
                call memory_deallo(memor,vanam//' % A',vacal,varia(idim1,idim2,idim3) % a)
             end do
          end do
       end do
  ...
  end subroutine memory_deallo_r3p_3
  ...
  subroutine memory_alloca_i81(memor,vanam,vacal,varia,ndim1,wzero,lboun,REALLOCATE)
    !
    ! Integer(8)(:)
    !
  ...
  subroutine memory_alloca_i82(memor,vanam,vacal,varia,ndim1,ndim2,wzero,lboun1,lboun2)
    !
    ! Integer(8)(:,:)
    !
  ...
  subroutine memory_copy_i1p_1(memor,vanam,vacal,vacpy,varia,wzero)
    !
    ! Type(i1p)(4)(:)
    !
  ...
  subroutine memory_copy_rp1(memor,vanam,vacal,vacpy,varia,wzero)
    !
    ! Real(rp)(:)
    !
  ...
  subroutine memory_copy_rp2(memor,vanam,vacal,vacpy,varia,wzero)
    !
    ! Real(rp)(:,:)
    !
 ...
 subroutine memory_copy_rp3(memor,vanam,vacal,vacpy,varia,wzero)
    !
    ! Real(rp)(:,:,:)
    !
  ...
  subroutine memory_resize_41(memor,vanam,vacal,varia,ndim1)
    ...
    if( ndim1 == 0_4 ) then
       ...
       if( varia_associated ) then
          call memory_copy(  memor,vanam,vacal,varia,vacpy,COPY_NAME=vanam//'_COPY')
       else
          call memory_alloca(memor,vanam//'_COPY',vacal,vacpy,ndim1)
       end if

       call memory_alloca(memor,vanam,vacal,varia,ndim1)
       if( varia_associated ) call memory_copy(  memor,vanam//'_COPY',vacal,vacpy,varia,COPY_NAME=vanam)
    end if
  ...
  subroutine memory_resize_42(memor,vanam,vacal,varia,ndim1,ndim2)
    ...
    if( ndim1 * ndim2 == 0_4 ) then
       ...
       if( varia_associated ) then
          ...
          call memory_alloca(memor,vanam//'_COPY',vacal,vacpy,ndim1,ndim2)
       end if
  ...
  subroutine memory_resize_43(memor,vanam,vacal,varia,ndim1,ndim2,ndim3)
    ...
    if( ndim1 * ndim2 * ndim3 == 0_4 ) then
       ...
       if( varia_associated ) then
          ...
          call memory_alloca(memor,vanam//'_COPY',vacal,vacpy,ndim1,ndim2,ndim3)
       end if
  ...
  subroutine memory_resize_r83(memor,vanam,vacal,varia,ndim1,ndim2,ndim3)
    !
    ! Real(rp)(:,:,:)
    !
  ...
  end subroutine memory_resize_r83

  subroutine memory_resize_r81(memor,vanam,vacal,varia,ndim1)
    !
    ! Real(rp)(:,:)
    !
  ...
  end subroutine memory_resize_r81

  subroutine memory_resize_r82(memor,vanam,vacal,varia,ndim1,ndim2)
    !
    ! Real(rp)(:,:)
    !
  ...
  end subroutine memory_resize_r82

  subroutine memory_resize_1p_1(memor,vanam,vacal,varia,ndim1)
    !
    ! Type(I1P)(:)
    !
  ...
  end subroutine memory_resize_1p_1
  ...
  subroutine memory_renumber_rp2(memor,vanam,vacal,varia,lrenu,idime)
    ...
    if( present(idime) ) then
       kdime_1 = idime
       call runend('MEMORY_RENUMBER_RP2: NOT CODED')
    else
       kdime_1 = 2
    end if
    if( kdime_1 == 1 ) then
       ...
       call runend('MEMORY_RENUMBER_RP2: WRONG DIMENSION')
    end if
    !
  ...
  function memory_size_rp1(varia,ndim1)
    !
    ! Real(rp)(:)
    !
  ...
  function memory_size_rp2(varia,ndim1)
    !
    ! Real(rp)(:,:)
    !
    ...
    if( associated(varia) ) then
       if( present(ndim1) ) then
          if( ndim1 >= 1 .and. ndim1 <= 2 ) then
             ...
             call runend('MEMORY_SIZE_: WRONG SIZE')
          end if
       else
  ...
  function memory_size_rp3(varia,ndim1)
    !
    ! Real(rp)(:,:,:)
    !
  ...
  function memory_size_rp4(varia,ndim1)
    !
    ! Real(rp)(:,:,:)
    !
  ...
  function memory_size_ip1_4(varia,ndim1)
    !
    ! Int(ip)(:)
    !
  ...
  function memory_size_ip1_8(varia,ndim1)
    !
    ! Int(ip)(:)
    !
  ...
  function memory_size_ip2_4(varia,ndim1)
    !
    ! Int(ip)(:,:)
    !
  ...
  function memory_size_ip2_8(varia,ndim1)
    !
    ! Int(ip)(:,:)
    !
  ...
  function memory_size_ip3_4(varia,ndim1)
    !
    ! Int(ip)(:,:,:)
    !
  ...
  function memory_size_ip3_8(varia,ndim1)
    !
    ! Int(ip)(:,:,:)
    !
  ...
  function memory_size_i1p_1(varia,ndime)
    !
    ! type(i1p)(:)
    !
  ...
  function memory_size_r1p_1(varia,ndime)
    !
    ! type(r1p)(:)
    !
  ...
  subroutine memory_initia_rp1(varia,VARIABLE_VALUE,lboun1,uboun1)
    ...
    if( associated(varia) ) then
       if( present(lboun1) ) then
          ...
          my_lboun1 = lbound(varia,1,KIND=ip)
       end if
       if( present(uboun1) ) then
          my_uboun1 = uboun1
       else
          my_uboun1 = ubound(varia,1,KIND=ip)
       end if
  ...
  subroutine memory_initia_rp3(varia,VARIABLE_VALUE)
    ...
    if( associated(varia) ) then
       ldim1 = lbound(varia,1,KIND=ip)
       ldim2 = lbound(varia,2,KIND=ip)
       ldim3 = lbound(varia,3,KIND=ip)
       udim1 = ubound(varia,1,KIND=ip)
       udim2 = ubound(varia,2,KIND=ip)
       udim3 = ubound(varia,3,KIND=ip)
       if( present(VARIABLE_VALUE) ) then

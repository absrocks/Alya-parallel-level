...
subroutine domain_destructor()
  ...
  ! Domain
  !
  call graphs_elepoi_deallocate(pelpo,  lelpo,  PELPO_NAME='PELPO',  LELPO_NAME='LELPO')
  call graphs_elepoi_deallocate(pelpo_2,lelpo_2,PELPO_NAME='PELPO_2',LELPO_NAME='LELPO_2')

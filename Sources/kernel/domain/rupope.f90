subroutine rupope(ndime,ngaus,posgp,weigp,ierro)
  ...
  if(ndime==3) then
     ...
     if( ngaus == 1 ) then
        ...
        a1 = 0.059715871789769820459_rp 
        a2 = 0.797426985353087322400_rp 
        b1 = 0.470142064105115089770_rp
        b2 = 0.101286507323456338800_rp
        ...
        weigp(  2)= 0.13239415278850618074_rp*w1*0.5_rp
        weigp(  3)= 0.13239415278850618074_rp*w1*0.5_rp
        weigp(  4)= 0.13239415278850618074_rp*w1*0.5_rp
        weigp(  5)= 0.12593918054482715260_rp*w1*0.5_rp
        weigp(  6)= 0.12593918054482715260_rp*w1*0.5_rp
        weigp(  7)= 0.12593918054482715260_rp*w1*0.5_rp

        weigp(  8)= 0.225_rp*w2*0.5_rp
        weigp(  9)= 0.13239415278850618074_rp*w2*0.5_rp
        weigp( 10)= 0.13239415278850618074_rp*w2*0.5_rp
        weigp( 11)= 0.13239415278850618074_rp*w2*0.5_rp
        weigp( 12)= 0.12593918054482715260_rp*w2*0.5_rp
        weigp( 13)= 0.12593918054482715260_rp*w2*0.5_rp
        weigp( 14)= 0.12593918054482715260_rp*w2*0.5_rp

        weigp( 15)= 0.225_rp*w1*0.5_rp
        weigp( 16)= 0.13239415278850618074_rp*w1*0.5_rp
        weigp( 17)= 0.13239415278850618074_rp*w1*0.5_rp
        weigp( 18)= 0.13239415278850618074_rp*w1*0.5_rp
        weigp( 19)= 0.12593918054482715260_rp*w1*0.5_rp
        weigp( 20)= 0.12593918054482715260_rp*w1*0.5_rp
        weigp( 21)= 0.12593918054482715260_rp*w1*0.5_rp

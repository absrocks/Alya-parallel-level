...
module mod_periodicity
  ...
  use def_master,                only : npart,comm_data_par
  ...
  use mod_communications,        only : PAR_MERGE_COMMUNICATION_ARRAY
...
10        continue
          ...
          !
          call PAR_INITIALIZE_COMMUNICATION_ARRAY(comm_sav)
          call PAR_COPY_COMMUNICATION_ARRAY(PAR_COMM_MY_CODE_ARRAY(1),comm_sav)
          ...
          call PAR_ALLOCATE_COMMUNICATION_ARRAY(PAR_COMM_MY_CODE_ARRAY(1))
          ...
          call PAR_DEALLOCATE_COMMUNICATION_ARRAY(comm_sav)

          call PAR_MERGE_COMMUNICATION_ARRAY(commd)
          !

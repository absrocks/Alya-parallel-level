subroutine domfac(ielty,pnodb,nface,lface,ltypf,nnodf)
  ...
  use mod_elmgeo, only     :  list_faces_BAR03,type_faces_BAR03
  use mod_elmgeo, only     :  list_faces_BAR04,type_faces_BAR04
  use mod_elmgeo, only     :  list_faces_TRI10,type_faces_TRI10
  ...
  use mod_elmgeo, only     :  list_faces_TET20,type_faces_TET20
  ...
  if( ielty < 10 ) then
     ...
     !   1      4       5      2
     !
     lface(1:4,1:3) = list_faces_TRI10(1:4,1:3)
     ltypf(1:3)     = type_faces_TRI10(1:3)
...
!!$     lface(9,iface) = 26
     ...
     ! TET10
     !
     lface(1:10,1:4) = list_faces_TET20(1:10,1:4)
     ltypf(1:4)     = type_faces_TET20(1:4)

...
subroutine exm_street
  ...
  real(rp),    dimension(:,:,:), pointer :: fabox_loc
  real(rp),    dimension(:,:,:), pointer :: sabox_loc
  integer(ip), dimension(:), pointer     :: blink_loc
  integer(ip), dimension(:), pointer     :: stru2_loc
  real(rp),    dimension(:), pointer     :: ldist_loc
  type(netyp), dimension(:), pointer     :: lnele_loc

...
contains
   ...
   subroutine exm_onecel(mat)
      ...
      if (kfl_hfmodmate_exm(mat) == 0) then  !if it's Normal
         ...
         if ((moneclmate_exm(2, n) == 1000) .and. (kfl_drugsmate_exm(n) == 0)) then   !Normal at 70 bpm
            call exm_init_voltages(EXM_ONECEL_NORMAL_70BMP, mat)
   ...
   subroutine exm_init_voltages(condition_type, mat)
      ...
      case (EXM_ONECEL_NORMAL_70BMP)

         !epicardial
         vminimate_exm(1:3, mat) = -85.23_rp     ! INTRA (BI-DOMAIN) OR SINGLE (MONO) POTENTIAL    !EPBench =-85.23  [mV]  <-
         vauin_exm(1, 1, mat) = 0.00172_rp       !Variable m
         vauin_exm(2, 1, mat) = 0.7444_rp        !Variable h                           !EPBench = 0.7444_rp
         vauin_exm(3, 1, mat) = 0.7045_rp        !Variable j                           !EPBench = 0.7045_rp
         vauin_exm(4, 1, mat) = 0.00003373_rp    !Variable d                           !EPBench = 0.00003373_rp
         vauin_exm(5, 1, mat) = 0.7888_rp        !Variable f                           !EPBench = 0.7888_rp
         vauin_exm(12, 1, mat) = 0.9755_rp       !Variable f2                          !EPBench = 0.9755_rp
         vauin_exm(6, 1, mat) = 0.9953_rp        !Variable fCa                         !EPBench = 0.9953_rp
         vauin_exm(7, 1, mat) = 0.0000000242_rp  !Variable r                           !EPBench = 0.0000000242_rp
         vauin_exm(8, 1, mat) = 0.999998_rp      !Variable s                           !EPBench = 0.999998_rp
         vauin_exm(9, 1, mat) = 0.0095_rp        !Variable xs                          !EPBench = 0.0095_rp
         vauin_exm(10, 1, mat) = 0.00621_rp      !Variable xr1                         !EPBench = 0.00621_rp
         vauin_exm(11, 1, mat) = 0.4712_rp       !Variable xr2                         !EPBench = 0.4712_rp
         vcoin_exm(1, 1, mat) = 0.000126_rp      !Variable Cai                         !EPBench = 0.000126_rp [mM]
         vcoin_exm(2, 1, mat) = 3.64_rp          !Variable CaSR                        !EPBench = 3.64_rp     [mM]
         vcoin_exm(3, 1, mat) = 8.608_rp         !Variable Nai                         !EPBench = 8.604_rp    [mM] <-
         vcoin_exm(4, 1, mat) = 136.89_rp        !Variable Ki                          !EPBench = 136.89_rp   [mM]
         vcoin_exm(5, 1, mat) = 0.00036_rp       !Variable CaSSi                       !EPBench = 0.0036_rpi  [mM]
         vcoin_exm(9, 1, mat) = 0.9073_rp        !Variable Rprime                      !EPBench = 0.9073_rp
         !endocardial
         vauin_exm(1, 2, mat) = 0.0016_rp        !Variable m
         vauin_exm(2, 2, mat) = 0.7573_rp        !Variables h
         vauin_exm(3, 2, mat) = 0.7225_rp        !Variable j
         vauin_exm(4, 2, mat) = 0.00003164_rp    !Variable d
         vauin_exm(5, 2, mat) = 0.8009_rp        !Variable f
         vauin_exm(12, 2, mat) = 0.9778_rp       !Variable f2
         vauin_exm(6, 2, mat) = 0.99530_rp       !Variable fCa
         vauin_exm(7, 2, mat) = 0.00000002235_rp !Variable r
         vauin_exm(8, 2, mat) = 0.3212_rp        !Variable s
         vauin_exm(9, 2, mat) = 0.0087_rp        !Variable xs
         vauin_exm(10, 2, mat) = 0.0045_rp       !Variable xr1
         vauin_exm(11, 2, mat) = 0.4760_rp       !Variable xr2
         vcoin_exm(1, 2, mat) = 0.00013_rp       !Variable Cai
         vcoin_exm(2, 2, mat) = 3.7150_rp        !Variable CaSR
         vcoin_exm(3, 2, mat) = 10.355_rp        !Variable Nai
         vcoin_exm(4, 2, mat) = 138.4_rp         !Variable Ki
         vcoin_exm(5, 2, mat) = 0.00036_rp       !Variable CaSS
         vcoin_exm(9, 2, mat) = 0.9068_rp        !Variable Rprime
         !midmyocardial
         vauin_exm(1, 3, mat) = 0.0017_rp        !Variable m
         vauin_exm(2, 3, mat) = 0.749_rp         !Variables h
         vauin_exm(3, 3, mat) = 0.6788_rp        !Variable j
         vauin_exm(4, 3, mat) = 0.00003288_rp    !Variable d
         vauin_exm(5, 3, mat) = 0.7026_rp        !Variable f
         vauin_exm(12, 3, mat) = 0.9526_rp       !Variable f2
         vauin_exm(6, 3, mat) = 0.99420_rp       ! Variable fCa
         vauin_exm(7, 3, mat) = 0.00000002347_rp !Variable r
         vauin_exm(8, 3, mat) = 1.0_rp           !Variable s
         vauin_exm(9, 3, mat) = 0.0174_rp        !Variable xs
         vauin_exm(10, 3, mat) = 0.0165_rp       !Variable xr1
         vauin_exm(11, 3, mat) = 0.473_rp        !Variable xr2
         vcoin_exm(1, 3, mat) = 0.000153_rp      !Variable Cai
         vcoin_exm(2, 3, mat) = 4.2720_rp        !Variable CaSR
         vcoin_exm(3, 3, mat) = 10.132_rp        !Variable Nai
         vcoin_exm(4, 3, mat) = 138.52_rp        !Variable Ki
         vcoin_exm(5, 3, mat) = 0.00042_rp       !Variable CaSS
         vcoin_exm(9, 3, mat) = 0.8978_rp        !Variable Rprime

      case (EXM_ONECEL_HF_70BPM)

         vminimate_exm(1, mat) = -83.4949_rp     ! INTRA (BI-DOMAIN) OR SINGLE (MONO) POTENTIAL
         vminimate_exm(2:3, mat) = -85.23_rp     ! INTRA (BI-DOMAIN) OR SINGLE (MONO) POTENTIAL    !EPBench =-85.23  [mV]  <-

         !EPICARDIAL HEART FAILURE
         !VOLTAGE -82.5277658119425
         vauin_exm(1, 1, mat) = 0.00303276091526701_rp
         vauin_exm(2, 1, mat) = 0.661659742738716_rp
         vauin_exm(3, 1, mat) = 0.634628244886488_rp
         vauin_exm(4, 1, mat) = 4.83560182302662e-05_rp
         vauin_exm(5, 1, mat) = 0.926032127446219_rp
         vauin_exm(12, 1, mat) = 0.999241154724418_rp
         vauin_exm(6, 1, mat) = 0.999869780216330_rp
         vauin_exm(7, 1, mat) = 3.79981651056992e-08_rp
         vauin_exm(8, 1, mat) = 0.999996272388211_rp
         vauin_exm(9, 1, mat) = 0.00455055453605926_rp
         vauin_exm(10, 1, mat) = 0.00168040788756380_rp
         vauin_exm(11, 1, mat) = 0.443217253596480_rp
         vcoin_exm(1, 1, mat) = 8.63303349957043e-05_rp
         vcoin_exm(2, 1, mat) = 2.97266869543131_rp
         vcoin_exm(3, 1, mat) = 9.72525639401306_rp
         vcoin_exm(4, 1, mat) = 135.848336580048_rp
         vcoin_exm(5, 1, mat) = 0.000257031579830260_rp
         vcoin_exm(9, 1, mat) = 0.980074819847184_rp

                !!!  ENDOCARDIAL  HEART FAILURE
         !  VOLTAGE -84.2920820453902
         vauin_exm(1, 2, mat) = 0.00209247866395593_rp
         vauin_exm(2, 2, mat) = 0.717586845558180_rp
         vauin_exm(3, 2, mat) = 0.703610324031878_rp
         vauin_exm(4, 2, mat) = 3.82182239461387e-05_rp
         vauin_exm(5, 2, mat) = 0.927116903038717_rp
         vauin_exm(12, 2, mat) = 0.997941159192524_rp
         vauin_exm(6, 2, mat) = 0.999857972863601_rp
         vauin_exm(7, 2, mat) = 2.82975518708235e-08_rp
         vauin_exm(8, 2, mat) = 0.499007377734646_rp
         vauin_exm(9, 2, mat) = 0.00404264224963596_rp
         vauin_exm(10, 2, mat) = 0.000568838457062049_rp
         vauin_exm(11, 2, mat) = 0.461434647116189_rp
         vcoin_exm(1, 2, mat) = 0.000132911621580043_rp
         vcoin_exm(2, 2, mat) = 3.97092446663378_rp
         vcoin_exm(3, 2, mat) = 10.1377699148182_rp
         vcoin_exm(4, 2, mat) = 138.592632537711_rp
         vcoin_exm(5, 2, mat) = 0.000283334727151014_rp
         vcoin_exm(9, 2, mat) = 0.979004485438106_rp

         !mid HEART FAILUREEXM_ONECEL_HF_70BPM 0.00238853756757240_rp           !Variable m
         vauin_exm(2, 3, mat) = 0.698129858756220_rp        !Variables h
         vauin_exm(3, 3, mat) = 0.670007606728020_rp        !Variable j
         vauin_exm(4, 3, mat) = 4.15544209009521e-05_rp           !Variable d
         vauin_exm(5, 3, mat) = 0.882815089054957_rp         !Variable f
         vauin_exm(12, 3, mat) = 0.995047915633200_rp          !Variable f2
         vauin_exm(6, 3, mat) = 0.999809858618127_rp         ! Variable fCa
         vauin_exm(7, 3, mat) = 3.14471296989901e-08_rp           !Variable r
         vauin_exm(8, 3, mat) = 0.999997027982031_rp           !Variable s
         vauin_exm(9, 3, mat) = 0.00539523790336693_rp        !Variable xs
         vauin_exm(10, 3, mat) = 0.00221286069613379_rp        !Variable xr1
         vauin_exm(11, 3, mat) = 0.454935810543141_rp       !Variable xr2
         vcoin_exm(1, 3, mat) = 0.000148758208418421_rp                 !Variable Cai
         vcoin_exm(2, 3, mat) = 4.50025313681586_rp                 !Variable CaSR
         vcoin_exm(3, 3, mat) = 9.73203055605199_rp                 !Variable Nai
         vcoin_exm(4, 3, mat) = 138.900841456135_rp                 !Variable Ki
         vcoin_exm(5, 3, mat) = 0.000316819832530177_rp                 !Variable CaSS
         vcoin_exm(9, 3, mat) = 0.976140456252427_rp        !Variable Rprime

...
!> @brief   Scattering
!> @details Here we compute the scattering coefficients for each pair of directions. This should be changed by a function that would read the parameters from a table.
!> @} 
!-----------------------------------------------------------------------

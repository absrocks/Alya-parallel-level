subroutine tem_openfi(itask)
  ...
  character(150)          :: fil_pdata_tem,fil_outpu_tem
  character(150)          :: fil_solve_tem,fil_splot_tem,fil_psmat_tem
  character(150)          :: fil_setse_tem,fil_setsb_tem,fil_cvgso_tem
  character(150)          :: fil_setsn_tem,fil_bound_tem,fil_funck_tem
  character(150)          :: fil_funcc_tem,fil_witne_tem,fil_intbc_tem

subroutine tem_matrix()
  ...
  use def_domain
  use def_coupli
  use def_kermod,         only :  wallcoupling_waexl, kfl_waexl_ker, temel_ker, kfl_temper_vect
  ...
  if( kfl_waexl_ker == 1_ip ) &
     call COU_GET_INTERPOLATE_POINTS_VALUES(1_ip,tempe,temel_ker,wallcoupling_waexl)

...
subroutine pts_solite()
  ...
  use def_master,         only : nparr,therm,zeror,pard1
  ...
  do while( comcont /= -1 )
     ...
     !$OMP              ti,tf,defor_pts,gamma_pts,K,g,strex,beta_pts,dtime_pts,ovstr,therm,                   &
     ...
     !$OMP              ndime,                                                                                &
#endif
     !$OMP              bvnat_pts,leleboun_pts,bouno_pts,kfl_slip_wall_pts,walld_slip_pts,resid_pts,          &

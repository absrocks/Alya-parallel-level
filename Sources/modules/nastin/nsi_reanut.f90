...
subroutine nsi_reanut()
  ...
  if( INOTSLAVE ) then
     ...
     kfl_asbou_nsi           = 3                                    ! Assembly type (0,1,2)
     ...
     do while(words(1)/='ENDNU')
        ...
        if( words(1) == 'VECTO' ) then
           ...
           !-->                                     
           !-->                                         -  CODINA: tau1 = 1 / [ 4 mu/h^2 + 2 |u|/h + |w| ] 
           !-->                                         -  SHAKIB: tau1 = 1 / [ 9*(4 mu/h^2)^2 + (2|u|/h)^2 + |w|^2 ]^1/2 ]]></inputLineHelp>
           !-->            <inputElement>
           ...
           !--></inputLine>
           !
           !.md<1>TAU_STRATEGY:               CODINA | SHAKIB | EXACT  | INCLUDE_TIME_STEP                                    $ Equation for stabilization parameter tau
           ...
           !-->                    limiter.
           !-->                    
           !-->                        -  GRADV:       Force viscosity (laminar + turbulent) gradient in residual
           !-->                        -  NO_LIMITER:  No limiter is used 
           !-->                        -  FIRST_ORDER: SUPG method (only first order) 
           !-->                        -  SOTO:        Soto's limiter 
           !-->                     ]]></inputLineHelp>
           !-->            <inputElement>
           !-->                <inputElementType>combo</inputElementType>
           ...
           !-->        </inputLine>
           !
           !.md<1><b>TRACKING_SUBGRID_SCALE:</b>     TIME[, ORDER= 1 | 2 ], COUPLED | DECOUPLED \
           ...
           if( exists('BOUND' ) ) then
              ...
              if(      words(2) == 'FAST ' ) then
                 ...
                 kfl_assem_nsi= 3
              else if( words(2) == 'GPU  ' ) then        ! Usar mod_nsi_element_operations_fast 
                 kfl_assem_nsi= 4

...
subroutine nsi_bouope(itask)
  ...
  !$OMP                 botem, tragl, hleng, gbcar, gbden, gbvis, veave,           &
  ...
  !$OMP                 velom, kfl_coupl, hnatu, kfl_prope,         &
  !$OMP                 kfl_kxmod_ker, ndimb, kfl_rough, rough_dom, dtinv_nsi,     &
        ...
        if( pelty > 0 ) then
           ...
           if( pmate /= -1 ) then
              ...
              call nsi_turbul(&
                   ...
                   gbcar,bovel,gbden,gbvis,gbmut,gbgvi,grvis,gbgve,ielem,kfl_kxmod_ker)
              ...
              gauss_points: do igaub = 1,pgaub
                 ...
                 if(     kfl_fixbo_nsi(iboun) ==  6 .or.&
                    ...
                    call cartbo(&
                         ...
                         elmar(pelty) % shaga,gpcar,elmar(pelty) % shape,  &
                         shapp,gbcar,pnodb,pnode,pgaus)
                    gpvis = gbvis(igaub)! + gbmut(igaub) ! gbmut was adde above by nsi_turbul
                    !call nsi_bouopb(&

...
subroutine nsi_elmresdiff_visco(pnode,pgaus,pevat,gpvol,gpsha,lnods, &
  ...
  use def_nastin, only     :  dtinv_nsi,resdiff_nsi, ndbgs_nsi,poauu_nsi,poaup_nsi,&
  ...
  real(rp)	             :: zero,fact0, fact1,fact2,fact3,fact4,fact6,elvel1(ndime*pnode),elpre1(pnode)

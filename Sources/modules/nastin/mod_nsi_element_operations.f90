...
contains
  ...
  subroutine nsi_element_operations(&
    ...
    use def_kermod,            only : kfl_kxmod_ker,kfl_prope
  ...
  subroutine nsi_element_operations_gather_scalar(&
    ...
    use def_nastin, only       :  kfl_timei_nsi,kfl_regim_nsi,nbdfp_nsi,&
         ...
         &                        kfl_bubbl_nsi,bubble_nsi,kfl_algor_nsi
    implicit none
  ...
  subroutine nsi_element_operations_gather_vector(&
    ...
    use def_nastin, only       :  kfl_timei_nsi,kfl_regim_nsi,nbdfp_nsi,&
         ...
         &                        kfl_immer_nsi,lagra_nsi,tauib_nsi,kfl_algor_nsi,&
         &                        kfl_lookg_nsi
    use mod_ker_proper, only   :  ker_proper
...
#define DEF_VECT 1:VECTOR_SIZE
    ...
    do ivect = 1,VECTOR_SIZE
       ...
       if (kfl_regim_nsi==3 .and. kfl_stabi_nsi == NSI_CONVECTION_EMAC ) then
          do igaus = 1,pgaus
             do idime = 1,ndime
                do jdime = 1,ndime
                   ...
                   do idime = 1,ndime
                      do jdime = 1,ndime
                         rmom2(DEF_VECT,idime,jdime,inode,igaus) = rmom2(DEF_VECT,idime,jdime,inode,igaus) &
                              + gpapo(DEF_VECT,idime,jdime,igaus) * gpsha(DEF_VECT,inode,igaus)
                      end do
                   end do
                end do
             end do
...
!!$              end do
!!$             call get_tendencies_u(gpcod,ctime, gpten_geo, gpten_adv) ! get geostrophic and advection forces
!!$             do igaus = 1,pgaus

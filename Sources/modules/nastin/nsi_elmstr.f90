subroutine nsi_elmstr(&
  ...
  use def_nastin, only       :  staco_nsi,dtsgs_nsi,&
       &                        tamax_nsi,tamin_nsi,kfl_sgsti_nsi,&
       &                        kfl_sgsco_nsi,misgs_nsi,tosgs_nsi,&
       &                        relsg_nsi,rmsgs_nsi,itsta_nsi,resis_nsi,&
       &                        kfl_taust_nsi,kfl_stabi_nsi,corio_nsi,&
       &                        kfl_sgsli_nsi,kfl_rmom2_nsi,pabdf_nsi,ncomp_nsi,kfl_linea_nsi
  implicit none
  ...
  integer(ip)                :: idime,igaus,inode,itsgs,jdime,ipoin

subroutine nsi_bousto(&
  ...
  real(rp)                 :: gbvel(ndime), resistive_term(ndime), gbpre, rhoun, udotn, fact1, one, fact2, p_in, rdummi
...
!!$  
!!$    rdummi=0.0_rp
!!$    call  mod_windk_interact(rdummi, p_in,'NASTIN', kfl_codbo(iboun), OPT_direction='OU')

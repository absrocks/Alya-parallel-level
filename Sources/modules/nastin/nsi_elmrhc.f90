subroutine nsi_elmrhc(&
  ...
  use def_master, only     :  press,unkno
  use def_domain, only     :  ndime,mnode,npoin,lelch
  use def_nastin, only     :  deltp_nsi,ndbgs_nsi,kfl_taush_nsi,&
       &                      kfl_algor_nsi,staco_nsi,kfl_predi_nsi,&
       &                      kfl_advec_nsi,ncomp_nsi,NSI_SCHUR_COMPLEMENT,&
       &                      pabdf_nsi

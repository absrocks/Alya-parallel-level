subroutine nsi_shuvec(itask,Auu,App,Apu,invAuu,Aup,xx,yy)
  ...
  use def_domain, only     :  npoin,ndime,nzdom,r_dom,c_dom
  use def_master, only     :  solve,NPOIN_TYPE,INOTMASTER,IMASTER,kfl_paral
  ...
  integer(ip)              :: izdom,idime
  integer(ip)              :: ipoin,jpoin,idofn

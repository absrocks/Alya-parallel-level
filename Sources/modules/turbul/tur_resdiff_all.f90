subroutine tur_resdiff_all(&
  ...
  use def_turbul, only       :  nturb_tur,iunkn_tur,kfl_timei_tur,&
       &                        kfl_weigh_tur,dtinv_tur,kfl_advec_tur, kfl_taust_tur, staco_tur,resdiff_tur
  use def_master
  use def_kermod, only       :  kfl_dvar_type,kfl_fixno_walld_ker,kfl_walld,kfl_nwall
  use mod_matrix
  ...
  integer(ip)                :: inode,jnode,idime,igaus,ipoin,ipoinwal

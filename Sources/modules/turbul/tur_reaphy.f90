        ...
        if(words(1)=='PROBL') then
           ...
           do while(words(1)/='ENDPR')
              ...
              if(words(1)=='MODEL') then
                 !.md<2>MODEL  SPALA |  STDKE | KOMEGA | SSTKO   RNG | REALI (WIND) | WIL88 | WIL98 | WIL06 |   
                 !.md<field>MODEL

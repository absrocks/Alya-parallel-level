subroutine tur_sstkom(&
  ...
  use def_master, only       :  untur,veloc,kfl_paral
  use def_domain, only       :  mnode
  use def_turbul, only       :  nturb_tur,iunkn_tur,kfl_algor_tur,kfl_clipp_tur,&
       &                        param_tur,kfl_ddesm_tur, cddes_tur,kfl_sasim_tur, kfl_rotat_tur
  implicit none

subroutine ibm_wallib()
  ...
  if( INOTMASTER ) then
     ...
     call memchk(zero,istat,mem_modul(1:2,modul),'PBOBO','ibm_wallib',pbobo)
     !
     ...
     call memchk(zero,istat,mem_modul(1:2,modul),'LISTA','ibm_wallib',lista)
     ...
     call memchk(zero,istat,mem_modul(1:2,modul),'LBOBO','ibm_wallib',lbobo)
     do iboun = 1, nedgb
     ...
     if ( nboun_tmp > 0 ) then
        ...
        call memchk(zero,istat,mem_modul(1:2,modul),'LCONV','ibm_wallib',lconv)

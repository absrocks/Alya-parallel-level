...
!> @} 
!-----------------------------------------------------------------------
subroutine sld_stress_model_134ma(&
  ...
  real(rp)                   :: a,b,af,afm,bf,as,bs,afs,bfs,afc,flag_2,scalf
  ...
  flag_2 = 0_ip  !activate second fiber field
...
!           fporf_2(idime,jdime) = nfibe_2(idime,igaus) * nfibe_2(jdime,igaus)
     ...
     do idime = 1,ndime
       do jdime = 1,ndime
         ...
         cauchy_shear1(idime,jdime) = term2*dev_fporf(idime,jdime)
         cauchy_shear2(idime,jdime) = term3*dev_spors(idime,jdime)
         cauchy_shear3(idime,jdime) = term4*(dev_fpors(idime,jdime)+dev_sporf(idime,jdime))
...
end subroutine sld_stress_model_134ma

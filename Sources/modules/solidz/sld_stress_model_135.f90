subroutine sld_stress_model_135(pgaus,pmate,gpcau,gpgdi,gpigd,gpstr,gpdet,pnode,elcod,lnods,ielem,gpsha,nfibe,&
  ...
  use def_solidz
  use def_master, only       :  kfl_modul,ID_EXMEDI,cutim,ittim,postp,ittyp,ITASK_ENDRUN,fiber,gpfib
  ...
  real(rp)                   :: castv(ndime,ndime),gpstv(ndime,ndime),elfib(3,mnode),lamda(3),ovlam(3),&
       term1,term2,term3,term4,dwdeg(ndime,ndime),gpgre(ndime,ndime),gpgrf(ndime,ndime)
  ...
  real(rp)                   :: i1,i4f,i4s,i4n,i4ff,i4sf

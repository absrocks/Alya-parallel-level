...
subroutine sld_bouope()
  ...
  real(rp)    :: gbsur,eucta,tract(ndime),kspring,muvisco,gppre,unormal,xnormal,fnormal,tnormal
        ...
        if(kfl_fixbo_sld(iboun)==2 &
           ...
           gauss_points: do igaub=1,pgaub
              ...
              if(kfl_fixbo_sld(iboun)==2) then
                 ...
                 tract(1:ndime) = - baloc(1:ndime,ndime) * cavities(icavi) % pres(ITER_K)     ! minus, because normal is defined pointing outwards

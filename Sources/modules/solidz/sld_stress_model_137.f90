...
subroutine sld_stress_model_137(&
  ...
  use def_solidz
  use def_master, only       :  &
       cutim,ittim,postp,ittyp,ITASK_ENDRUN,fiber,vconc,coupling,kfl_paral,fisoc
  ...
  real(rp)                   :: detf0,nfibe_length,nfibe(ndime,pgaus),nfibe_2(ndime,pgaus)

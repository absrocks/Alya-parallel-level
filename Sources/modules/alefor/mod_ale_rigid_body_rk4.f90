...
contains 
  ...
  subroutine ale_rigid_body_rk4_solution(theta, phi, vel_theta, vel_phi, dtrb, Irb, Frb, hcm, krb, difrb, mrb, grb, option)
    ...
    real(rp)                :: theta_aux            ! auxiliar for iterations generalized coordinate
    real(rp)                :: theta_aux2           ! auxiliar for iterations generalized coordinate    
    real(rp)                :: phi_aux              ! auxiliar for iterations generalized coordinate
    real(rp)                :: vel_theta_aux        ! auxiliar for iterations generalized velocity
    real(rp)                :: vel_phi_aux          ! auxiliar for iterations generalized velocity

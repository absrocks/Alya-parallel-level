subroutine rad_exasol(itask,kfl_exacs_rad,ndime,&
     gpcod,exadv,exdif,exrea,extem,exgrt) 

!-----------------------------------------------------------------------
!    
! Exact solution for the radiation equation  !!F  NEED TO PUT REAL EXACT SOLUTIONS HERE
!
!-----------------------------------------------------------------------
  use def_kintyp
  use def_parame
  implicit none
  integer(ip), intent(in)  :: itask,kfl_exacs_rad,ndime
